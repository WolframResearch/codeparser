	...
	StringNode[String, {
			...
			GroupNode[GroupSquare, {
				...
				BinaryNode[Pattern, {
					...
					LeafNode[Token`WhiteSpace, " ", <|Source -> {{1, 6}, {1, 7}}|>],
...
Test[
	...
	StringNode[String, {
		GroupNode[List, {
			...
			LeafNode[Token`WhiteSpace, " ", <|Source -> {{1, 11}, {1, 12}}|>],
