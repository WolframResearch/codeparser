		...
		CallNode[LeafNode[Symbol, "List", <||>], {
			CallNode[LeafNode[Symbol, "Plus", <||>], {
	    		AbstractSyntaxErrorNode[AbstractSyntaxError`ExpectedOperand, {
	    			LeafNode[Token`Error`ExpectedOperand, "", <|Source->{{1, 4}, {1, 4}}|>]}, <|Source -> {{1, 4}, {1, 4}}|>]}, <|Source -> {{1, 3}, {1, 4}}|>]}, <|Source -> {{1, 1}, {1, 6}}|>] }, <||>]
	,
...
Test[
	...
	StringNode[String, {
		CallNode[LeafNode[Symbol, "Function", <||>], {
			AbstractSyntaxErrorNode[AbstractSyntaxError`ExpectedOperand, {
				LeafNode[Token`Error`ExpectedOperand, "", <|Source->{{1, 1}, {1, 1}}|>]}, <|Source -> {{1, 1}, {1, 1}}|>]}, <|Source -> {{1, 1}, {1, 2}}|>] }, <||>]
	,
