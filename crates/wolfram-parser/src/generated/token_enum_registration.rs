...
pub fn SymbolToToken(symbol: SymbolRef) -> Option<TokenKind> {
    ...
    let token = match symbol {
        st::SYMBOL_TOKEN_UNKNOWN => Unknown,
        st::SYMBOL_ENDOFFILE => EndOfFile,
        st::SYMBOL_SYMBOL => Symbol,
        st::SYMBOL_STRING => String,
        st::SYMBOL_INTEGER => Integer,
        st::SYMBOL_REAL => Real,
        st::SYMBOL_RATIONAL => Rational,
        st::SYMBOL_TOKEN_LINEARSYNTAXBLOB => LinearSyntaxBlob,
        st::SYMBOL_TOKEN_NEWLINE => InternalNewline,
        st::SYMBOL_TOKEN_COMMENT => Comment,
        st::SYMBOL_WHITESPACE => Whitespace,
        st::SYMBOL_TOKEN_BUFFER1 => Buffer1,
        st::SYMBOL_TOKEN_NEWLINE => ToplevelNewline,
        st::SYMBOL_TOKEN_BUFFER2 => Buffer2,
        st::SYMBOL_TOKEN_BUFFER3 => Buffer3,
        st::SYMBOL_TOKEN_BUFFER4 => Buffer4,
        st::SYMBOL_TOKEN_ERROR_EXPECTEDEQUAL => Error_ExpectedEqual,
        st::SYMBOL_TOKEN_ERROR_NUMBER => Error_Number,
        st::SYMBOL_TOKEN_ERROR_UNHANDLEDCHARACTER => Error_UnhandledCharacter,
        st::SYMBOL_TOKEN_ERROR_EXPECTEDLETTERLIKE => Error_ExpectedLetterlike,
        st::SYMBOL_TOKEN_ERROR_ABORTED => Error_Aborted,
        st::SYMBOL_TOKEN_ERROR_EXPECTEDOPERAND => Error_ExpectedOperand,
        st::SYMBOL_TOKEN_ERROR_EXPECTEDTAG => Error_ExpectedTag,
        st::SYMBOL_TOKEN_ERROR_EXPECTEDFILE => Error_ExpectedFile,
        st::SYMBOL_TOKEN_ERROR_UNEXPECTEDCLOSER => Error_UnexpectedCloser,
        st::SYMBOL_TOKEN_ERROR_PREFIXIMPLICITNULL => Error_PrefixImplicitNull,
        st::SYMBOL_TOKEN_ERROR_INFIXIMPLICITNULL => Error_InfixImplicitNull,
        st::SYMBOL_TOKEN_ERROR_UNSAFECHARACTERENCODING => Error_UnsafeCharacterEncoding,
        st::SYMBOL_TOKEN_ERROR_UNTERMINATEDCOMMENT => Error_UnterminatedComment,
        st::SYMBOL_TOKEN_ERROR_UNTERMINATEDSTRING => Error_UnterminatedString,
        st::SYMBOL_TOKEN_ERROR_UNTERMINATEDFILESTRING => Error_UnterminatedFileString,
        st::SYMBOL_TOKEN_ERROR_UNTERMINATEDLINEARSYNTAXBLOB => Error_UnterminatedLinearSyntaxBlob,
        st::SYMBOL_TOKEN_ERROR_UNSUPPORTEDTOKEN => Error_UnsupportedToken,
        st::SYMBOL_TOKEN_ERROR_UNEXPECTEDCOMMENTCLOSER => Error_UnexpectedCommentCloser,
        st::SYMBOL_TOKEN_ERROR_END => Error_End,
        st::SYMBOL_TOKEN_DOT => Dot,
        st::SYMBOL_TOKEN_COLON => Colon,
        st::SYMBOL_TOKEN_OPENPAREN => OpenParen,
        st::SYMBOL_TOKEN_CLOSEPAREN => CloseParen,
        st::SYMBOL_TOKEN_OPENSQUARE => OpenSquare,
        st::SYMBOL_TOKEN_CLOSESQUARE => CloseSquare,
        st::SYMBOL_TOKEN_COMMA => Comma,
        st::SYMBOL_TOKEN_OPENCURLY => OpenCurly,
        st::SYMBOL_TOKEN_CLOSECURLY => CloseCurly,
        st::SYMBOL_TOKEN_EQUAL => Equal,
        st::SYMBOL_TOKEN_BANG => Bang,
        st::SYMBOL_TOKEN_UNDER => Under,
        st::SYMBOL_TOKEN_LESS => Less,
        st::SYMBOL_TOKEN_GREATER => Greater,
        st::SYMBOL_TOKEN_MINUS => Minus,
        st::SYMBOL_TOKEN_BAR => Bar,
        st::SYMBOL_TOKEN_SEMI => Semi,
        st::SYMBOL_TOKEN_HASH => Hash,
        st::SYMBOL_TOKEN_AMP => Amp,
        st::SYMBOL_TOKEN_SLASH => Slash,
        st::SYMBOL_TOKEN_AT => At,
        st::SYMBOL_TOKEN_PLUS => Plus,
        st::SYMBOL_TOKEN_TILDE => Tilde,
        st::SYMBOL_TOKEN_STAR => Star,
        st::SYMBOL_TOKEN_CARET => Caret,
        st::SYMBOL_TOKEN_SINGLEQUOTE => SingleQuote,
        st::SYMBOL_TOKEN_PERCENT => Percent,
        st::SYMBOL_TOKEN_QUESTION => Question,
        st::SYMBOL_TOKEN_DOTDOT => DotDot,
        st::SYMBOL_TOKEN_COLONCOLON => ColonColon,
        st::SYMBOL_TOKEN_COLONEQUAL => ColonEqual,
        st::SYMBOL_TOKEN_COLONGREATER => ColonGreater,
        st::SYMBOL_TOKEN_EQUALEQUAL => EqualEqual,
        st::SYMBOL_TOKEN_UNDERUNDER => UnderUnder,
        st::SYMBOL_TOKEN_UNDERDOT => UnderDot,
        st::SYMBOL_TOKEN_LESSBAR => LessBar,
        st::SYMBOL_TOKEN_LESSLESS => LessLess,
        st::SYMBOL_TOKEN_LESSGREATER => LessGreater,
        st::SYMBOL_TOKEN_LESSEQUAL => LessEqual,
        st::SYMBOL_TOKEN_GREATERGREATER => GreaterGreater,
        st::SYMBOL_TOKEN_GREATEREQUAL => GreaterEqual,
        st::SYMBOL_TOKEN_MINUSGREATER => MinusGreater,
        st::SYMBOL_TOKEN_MINUSMINUS => MinusMinus,
        st::SYMBOL_TOKEN_MINUSEQUAL => MinusEqual,
        st::SYMBOL_TOKEN_BARBAR => BarBar,
        st::SYMBOL_TOKEN_BARGREATER => BarGreater,
        st::SYMBOL_TOKEN_SEMISEMI => SemiSemi,
        st::SYMBOL_TOKEN_AMPAMP => AmpAmp,
        st::SYMBOL_TOKEN_SLASHAT => SlashAt,
        st::SYMBOL_TOKEN_SLASHSEMI => SlashSemi,
        st::SYMBOL_TOKEN_SLASHDOT => SlashDot,
        st::SYMBOL_TOKEN_SLASHSLASH => SlashSlash,
        st::SYMBOL_TOKEN_SLASHCOLON => SlashColon,
        st::SYMBOL_TOKEN_SLASHEQUAL => SlashEqual,
        st::SYMBOL_TOKEN_SLASHSTAR => SlashStar,
        st::SYMBOL_TOKEN_ATAT => AtAt,
        st::SYMBOL_TOKEN_ATSTAR => AtStar,
        st::SYMBOL_TOKEN_PLUSPLUS => PlusPlus,
        st::SYMBOL_TOKEN_PLUSEQUAL => PlusEqual,
        st::SYMBOL_TOKEN_TILDETILDE => TildeTilde,
        st::SYMBOL_TOKEN_STAREQUAL => StarEqual,
        st::SYMBOL_TOKEN_STARSTAR => StarStar,
        st::SYMBOL_TOKEN_CARETEQUAL => CaretEqual,
        st::SYMBOL_TOKEN_HASHHASH => HashHash,
        st::SYMBOL_TOKEN_BANGEQUAL => BangEqual,
        st::SYMBOL_TOKEN_BANGBANG => BangBang,
        st::SYMBOL_TOKEN_QUESTIONQUESTION => QuestionQuestion,
        st::SYMBOL_TOKEN_DOTDOTDOT => DotDotDot,
        st::SYMBOL_TOKEN_EQUALEQUALEQUAL => EqualEqualEqual,
        st::SYMBOL_TOKEN_EQUALBANGEQUAL => EqualBangEqual,
        st::SYMBOL_TOKEN_UNDERUNDERUNDER => UnderUnderUnder,
        st::SYMBOL_TOKEN_SLASHSLASHDOT => SlashSlashDot,
        st::SYMBOL_TOKEN_ATATAT => AtAtAt,
        st::SYMBOL_TOKEN_LESSMINUSGREATER => LessMinusGreater,
        st::SYMBOL_TOKEN_SLASHSLASHAT => SlashSlashAt,
        st::SYMBOL_TOKEN_CARETCOLONEQUAL => CaretColonEqual,
        st::SYMBOL_TOKEN_GREATERGREATERGREATER => GreaterGreaterGreater,
        st::SYMBOL_TOKEN_BARMINUSGREATER => BarMinusGreater,
        st::SYMBOL_TOKEN_SLASHSLASHEQUAL => SlashSlashEqual,
        st::SYMBOL_TOKEN_COLONCOLONOPENSQUARE => ColonColonOpenSquare,
        st::SYMBOL_TOKEN_PERCENTPERCENT => PercentPercent,
        st::SYMBOL_TOKEN_LINEARSYNTAX_BANG => LinearSyntax_Bang,
        st::SYMBOL_TOKEN_LINEARSYNTAX_CLOSEPAREN => LinearSyntax_CloseParen,
        st::SYMBOL_TOKEN_LINEARSYNTAX_AT => LinearSyntax_At,
        st::SYMBOL_TOKEN_LINEARSYNTAX_AMP => LinearSyntax_Amp,
        st::SYMBOL_TOKEN_LINEARSYNTAX_STAR => LinearSyntax_Star,
        st::SYMBOL_TOKEN_LINEARSYNTAX_UNDER => LinearSyntax_Under,
        st::SYMBOL_TOKEN_LINEARSYNTAX_CARET => LinearSyntax_Caret,
        st::SYMBOL_TOKEN_LINEARSYNTAX_SPACE => LinearSyntax_Space,
        st::SYMBOL_TOKEN_LINEARSYNTAX_PERCENT => LinearSyntax_Percent,
        st::SYMBOL_TOKEN_LINEARSYNTAX_PLUS => LinearSyntax_Plus,
        st::SYMBOL_TOKEN_LINEARSYNTAX_SLASH => LinearSyntax_Slash,
        st::SYMBOL_TOKEN_LINEARSYNTAX_BACKTICK => LinearSyntax_BackTick,
        st::SYMBOL_TOKEN_FAKE_IMPLICITTIMES => Fake_ImplicitTimes,
        st::SYMBOL_TOKEN_FAKE_IMPLICITNULL => Fake_ImplicitNull,
        st::SYMBOL_TOKEN_FAKE_IMPLICITONE => Fake_ImplicitOne,
        st::SYMBOL_TOKEN_FAKE_IMPLICITALL => Fake_ImplicitAll,
        st::SYMBOL_TOKEN_BOXES_OPENPARENSTAR => Boxes_OpenParenStar,
        st::SYMBOL_TOKEN_BOXES_STARCLOSEPAREN => Boxes_StarCloseParen,
        st::SYMBOL_TOKEN_BOXES_MULTISINGLEQUOTE => Boxes_MultiSingleQuote,
        st::SYMBOL_TOKEN_BOXES_MULTIWHITESPACE => Boxes_MultiWhitespace,
        st::SYMBOL_TOKEN_LONGNAME_NOT => LongName_Not,
        st::SYMBOL_TOKEN_LONGNAME_PLUSMINUS => LongName_PlusMinus,
        st::SYMBOL_TOKEN_LONGNAME_CENTERDOT => LongName_CenterDot,
        st::SYMBOL_TOKEN_LONGNAME_TIMES => LongName_Times,
        st::SYMBOL_TOKEN_LONGNAME_DIVIDE => LongName_Divide,
        st::SYMBOL_TOKEN_LONGNAME_OPENCURLYQUOTE => LongName_OpenCurlyQuote,
        st::SYMBOL_TOKEN_LONGNAME_CLOSECURLYQUOTE => LongName_CloseCurlyQuote,
        st::SYMBOL_TOKEN_LONGNAME_OPENCURLYDOUBLEQUOTE => LongName_OpenCurlyDoubleQuote,
        st::SYMBOL_TOKEN_LONGNAME_CLOSECURLYDOUBLEQUOTE => LongName_CloseCurlyDoubleQuote,
        st::SYMBOL_TOKEN_LONGNAME_INVISIBLETIMES => LongName_InvisibleTimes,
        st::SYMBOL_TOKEN_LONGNAME_LEFTARROW => LongName_LeftArrow,
        st::SYMBOL_TOKEN_LONGNAME_UPARROW => LongName_UpArrow,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTARROW => LongName_RightArrow,
        st::SYMBOL_TOKEN_LONGNAME_DOWNARROW => LongName_DownArrow,
        st::SYMBOL_TOKEN_LONGNAME_LEFTRIGHTARROW => LongName_LeftRightArrow,
        st::SYMBOL_TOKEN_LONGNAME_UPDOWNARROW => LongName_UpDownArrow,
        st::SYMBOL_TOKEN_LONGNAME_UPPERLEFTARROW => LongName_UpperLeftArrow,
        st::SYMBOL_TOKEN_LONGNAME_UPPERRIGHTARROW => LongName_UpperRightArrow,
        st::SYMBOL_TOKEN_LONGNAME_LOWERRIGHTARROW => LongName_LowerRightArrow,
        st::SYMBOL_TOKEN_LONGNAME_LOWERLEFTARROW => LongName_LowerLeftArrow,
        st::SYMBOL_TOKEN_LONGNAME_LEFTTEEARROW => LongName_LeftTeeArrow,
        st::SYMBOL_TOKEN_LONGNAME_UPTEEARROW => LongName_UpTeeArrow,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTTEEARROW => LongName_RightTeeArrow,
        st::SYMBOL_TOKEN_LONGNAME_DOWNTEEARROW => LongName_DownTeeArrow,
        st::SYMBOL_TOKEN_LONGNAME_LEFTVECTOR => LongName_LeftVector,
        st::SYMBOL_TOKEN_LONGNAME_DOWNLEFTVECTOR => LongName_DownLeftVector,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTUPVECTOR => LongName_RightUpVector,
        st::SYMBOL_TOKEN_LONGNAME_LEFTUPVECTOR => LongName_LeftUpVector,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTVECTOR => LongName_RightVector,
        st::SYMBOL_TOKEN_LONGNAME_DOWNRIGHTVECTOR => LongName_DownRightVector,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTDOWNVECTOR => LongName_RightDownVector,
        st::SYMBOL_TOKEN_LONGNAME_LEFTDOWNVECTOR => LongName_LeftDownVector,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTARROWLEFTARROW => LongName_RightArrowLeftArrow,
        st::SYMBOL_TOKEN_LONGNAME_UPARROWDOWNARROW => LongName_UpArrowDownArrow,
        st::SYMBOL_TOKEN_LONGNAME_LEFTARROWRIGHTARROW => LongName_LeftArrowRightArrow,
        st::SYMBOL_TOKEN_LONGNAME_REVERSEEQUILIBRIUM => LongName_ReverseEquilibrium,
        st::SYMBOL_TOKEN_LONGNAME_EQUILIBRIUM => LongName_Equilibrium,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLELEFTARROW => LongName_DoubleLeftArrow,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLEUPARROW => LongName_DoubleUpArrow,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLERIGHTARROW => LongName_DoubleRightArrow,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLEDOWNARROW => LongName_DoubleDownArrow,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLELEFTRIGHTARROW => LongName_DoubleLeftRightArrow,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLEUPDOWNARROW => LongName_DoubleUpDownArrow,
        st::SYMBOL_TOKEN_LONGNAME_LEFTARROWBAR => LongName_LeftArrowBar,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTARROWBAR => LongName_RightArrowBar,
        st::SYMBOL_TOKEN_LONGNAME_DOWNARROWUPARROW => LongName_DownArrowUpArrow,
        st::SYMBOL_TOKEN_LONGNAME_FORALL => LongName_ForAll,
        st::SYMBOL_TOKEN_LONGNAME_PARTIALD => LongName_PartialD,
        st::SYMBOL_TOKEN_LONGNAME_EXISTS => LongName_Exists,
        st::SYMBOL_TOKEN_LONGNAME_NOTEXISTS => LongName_NotExists,
        st::SYMBOL_TOKEN_LONGNAME_DEL => LongName_Del,
        st::SYMBOL_TOKEN_LONGNAME_ELEMENT => LongName_Element,
        st::SYMBOL_TOKEN_LONGNAME_NOTELEMENT => LongName_NotElement,
        st::SYMBOL_TOKEN_LONGNAME_REVERSEELEMENT => LongName_ReverseElement,
        st::SYMBOL_TOKEN_LONGNAME_NOTREVERSEELEMENT => LongName_NotReverseElement,
        st::SYMBOL_TOKEN_LONGNAME_SUCHTHAT => LongName_SuchThat,
        st::SYMBOL_TOKEN_LONGNAME_PRODUCT => LongName_Product,
        st::SYMBOL_TOKEN_LONGNAME_COPRODUCT => LongName_Coproduct,
        st::SYMBOL_TOKEN_LONGNAME_SUM => LongName_Sum,
        st::SYMBOL_TOKEN_LONGNAME_MINUS => LongName_Minus,
        st::SYMBOL_TOKEN_LONGNAME_MINUSPLUS => LongName_MinusPlus,
        st::SYMBOL_TOKEN_LONGNAME_DIVISIONSLASH => LongName_DivisionSlash,
        st::SYMBOL_TOKEN_LONGNAME_BACKSLASH => LongName_Backslash,
        st::SYMBOL_TOKEN_LONGNAME_SMALLCIRCLE => LongName_SmallCircle,
        st::SYMBOL_TOKEN_LONGNAME_SQRT => LongName_Sqrt,
        st::SYMBOL_TOKEN_LONGNAME_CUBEROOT => LongName_CubeRoot,
        st::SYMBOL_TOKEN_LONGNAME_PROPORTIONAL => LongName_Proportional,
        st::SYMBOL_TOKEN_LONGNAME_DIVIDES => LongName_Divides,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLEVERTICALBAR => LongName_DoubleVerticalBar,
        st::SYMBOL_TOKEN_LONGNAME_NOTDOUBLEVERTICALBAR => LongName_NotDoubleVerticalBar,
        st::SYMBOL_TOKEN_LONGNAME_AND => LongName_And,
        st::SYMBOL_TOKEN_LONGNAME_OR => LongName_Or,
        st::SYMBOL_TOKEN_LONGNAME_INTEGRAL => LongName_Integral,
        st::SYMBOL_TOKEN_LONGNAME_CONTOURINTEGRAL => LongName_ContourIntegral,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLECONTOURINTEGRAL => LongName_DoubleContourIntegral,
        st::SYMBOL_TOKEN_LONGNAME_CLOCKWISECONTOURINTEGRAL => LongName_ClockwiseContourIntegral,
        st::SYMBOL_TOKEN_LONGNAME_COUNTERCLOCKWISECONTOURINTEGRAL => LongName_CounterClockwiseContourIntegral,
        st::SYMBOL_TOKEN_LONGNAME_THEREFORE => LongName_Therefore,
        st::SYMBOL_TOKEN_LONGNAME_BECAUSE => LongName_Because,
        st::SYMBOL_TOKEN_LONGNAME_COLON => LongName_Colon,
        st::SYMBOL_TOKEN_LONGNAME_PROPORTION => LongName_Proportion,
        st::SYMBOL_TOKEN_LONGNAME_TILDE => LongName_Tilde,
        st::SYMBOL_TOKEN_LONGNAME_VERTICALTILDE => LongName_VerticalTilde,
        st::SYMBOL_TOKEN_LONGNAME_NOTTILDE => LongName_NotTilde,
        st::SYMBOL_TOKEN_LONGNAME_EQUALTILDE => LongName_EqualTilde,
        st::SYMBOL_TOKEN_LONGNAME_TILDEEQUAL => LongName_TildeEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTTILDEEQUAL => LongName_NotTildeEqual,
        st::SYMBOL_TOKEN_LONGNAME_TILDEFULLEQUAL => LongName_TildeFullEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTTILDEFULLEQUAL => LongName_NotTildeFullEqual,
        st::SYMBOL_TOKEN_LONGNAME_TILDETILDE => LongName_TildeTilde,
        st::SYMBOL_TOKEN_LONGNAME_NOTTILDETILDE => LongName_NotTildeTilde,
        st::SYMBOL_TOKEN_LONGNAME_CUPCAP => LongName_CupCap,
        st::SYMBOL_TOKEN_LONGNAME_HUMPDOWNHUMP => LongName_HumpDownHump,
        st::SYMBOL_TOKEN_LONGNAME_HUMPEQUAL => LongName_HumpEqual,
        st::SYMBOL_TOKEN_LONGNAME_DOTEQUAL => LongName_DotEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTEQUAL => LongName_NotEqual,
        st::SYMBOL_TOKEN_LONGNAME_CONGRUENT => LongName_Congruent,
        st::SYMBOL_TOKEN_LONGNAME_NOTCONGRUENT => LongName_NotCongruent,
        st::SYMBOL_TOKEN_LONGNAME_LESSEQUAL => LongName_LessEqual,
        st::SYMBOL_TOKEN_LONGNAME_GREATEREQUAL => LongName_GreaterEqual,
        st::SYMBOL_TOKEN_LONGNAME_LESSFULLEQUAL => LongName_LessFullEqual,
        st::SYMBOL_TOKEN_LONGNAME_GREATERFULLEQUAL => LongName_GreaterFullEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTLESSFULLEQUAL => LongName_NotLessFullEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTGREATERFULLEQUAL => LongName_NotGreaterFullEqual,
        st::SYMBOL_TOKEN_LONGNAME_LESSLESS => LongName_LessLess,
        st::SYMBOL_TOKEN_LONGNAME_GREATERGREATER => LongName_GreaterGreater,
        st::SYMBOL_TOKEN_LONGNAME_NOTCUPCAP => LongName_NotCupCap,
        st::SYMBOL_TOKEN_LONGNAME_NOTLESS => LongName_NotLess,
        st::SYMBOL_TOKEN_LONGNAME_NOTGREATER => LongName_NotGreater,
        st::SYMBOL_TOKEN_LONGNAME_NOTLESSEQUAL => LongName_NotLessEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTGREATEREQUAL => LongName_NotGreaterEqual,
        st::SYMBOL_TOKEN_LONGNAME_LESSTILDE => LongName_LessTilde,
        st::SYMBOL_TOKEN_LONGNAME_GREATERTILDE => LongName_GreaterTilde,
        st::SYMBOL_TOKEN_LONGNAME_NOTLESSTILDE => LongName_NotLessTilde,
        st::SYMBOL_TOKEN_LONGNAME_NOTGREATERTILDE => LongName_NotGreaterTilde,
        st::SYMBOL_TOKEN_LONGNAME_LESSGREATER => LongName_LessGreater,
        st::SYMBOL_TOKEN_LONGNAME_GREATERLESS => LongName_GreaterLess,
        st::SYMBOL_TOKEN_LONGNAME_NOTLESSGREATER => LongName_NotLessGreater,
        st::SYMBOL_TOKEN_LONGNAME_NOTGREATERLESS => LongName_NotGreaterLess,
        st::SYMBOL_TOKEN_LONGNAME_PRECEDES => LongName_Precedes,
        st::SYMBOL_TOKEN_LONGNAME_SUCCEEDS => LongName_Succeeds,
        st::SYMBOL_TOKEN_LONGNAME_PRECEDESSLANTEQUAL => LongName_PrecedesSlantEqual,
        st::SYMBOL_TOKEN_LONGNAME_SUCCEEDSSLANTEQUAL => LongName_SucceedsSlantEqual,
        st::SYMBOL_TOKEN_LONGNAME_PRECEDESTILDE => LongName_PrecedesTilde,
        st::SYMBOL_TOKEN_LONGNAME_SUCCEEDSTILDE => LongName_SucceedsTilde,
        st::SYMBOL_TOKEN_LONGNAME_NOTPRECEDES => LongName_NotPrecedes,
        st::SYMBOL_TOKEN_LONGNAME_NOTSUCCEEDS => LongName_NotSucceeds,
        st::SYMBOL_TOKEN_LONGNAME_SUBSET => LongName_Subset,
        st::SYMBOL_TOKEN_LONGNAME_SUPERSET => LongName_Superset,
        st::SYMBOL_TOKEN_LONGNAME_NOTSUBSET => LongName_NotSubset,
        st::SYMBOL_TOKEN_LONGNAME_NOTSUPERSET => LongName_NotSuperset,
        st::SYMBOL_TOKEN_LONGNAME_SUBSETEQUAL => LongName_SubsetEqual,
        st::SYMBOL_TOKEN_LONGNAME_SUPERSETEQUAL => LongName_SupersetEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTSUBSETEQUAL => LongName_NotSubsetEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTSUPERSETEQUAL => LongName_NotSupersetEqual,
        st::SYMBOL_TOKEN_LONGNAME_UNIONPLUS => LongName_UnionPlus,
        st::SYMBOL_TOKEN_LONGNAME_SQUARESUBSET => LongName_SquareSubset,
        st::SYMBOL_TOKEN_LONGNAME_SQUARESUPERSET => LongName_SquareSuperset,
        st::SYMBOL_TOKEN_LONGNAME_SQUARESUBSETEQUAL => LongName_SquareSubsetEqual,
        st::SYMBOL_TOKEN_LONGNAME_SQUARESUPERSETEQUAL => LongName_SquareSupersetEqual,
        st::SYMBOL_TOKEN_LONGNAME_SQUAREINTERSECTION => LongName_SquareIntersection,
        st::SYMBOL_TOKEN_LONGNAME_SQUAREUNION => LongName_SquareUnion,
        st::SYMBOL_TOKEN_LONGNAME_CIRCLEPLUS => LongName_CirclePlus,
        st::SYMBOL_TOKEN_LONGNAME_CIRCLEMINUS => LongName_CircleMinus,
        st::SYMBOL_TOKEN_LONGNAME_CIRCLETIMES => LongName_CircleTimes,
        st::SYMBOL_TOKEN_LONGNAME_CIRCLEDOT => LongName_CircleDot,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTTEE => LongName_RightTee,
        st::SYMBOL_TOKEN_LONGNAME_LEFTTEE => LongName_LeftTee,
        st::SYMBOL_TOKEN_LONGNAME_DOWNTEE => LongName_DownTee,
        st::SYMBOL_TOKEN_LONGNAME_UPTEE => LongName_UpTee,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLERIGHTTEE => LongName_DoubleRightTee,
        st::SYMBOL_TOKEN_LONGNAME_LEFTTRIANGLE => LongName_LeftTriangle,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTTRIANGLE => LongName_RightTriangle,
        st::SYMBOL_TOKEN_LONGNAME_LEFTTRIANGLEEQUAL => LongName_LeftTriangleEqual,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTTRIANGLEEQUAL => LongName_RightTriangleEqual,
        st::SYMBOL_TOKEN_LONGNAME_XOR => LongName_Xor,
        st::SYMBOL_TOKEN_LONGNAME_NAND => LongName_Nand,
        st::SYMBOL_TOKEN_LONGNAME_NOR => LongName_Nor,
        st::SYMBOL_TOKEN_LONGNAME_WEDGE => LongName_Wedge,
        st::SYMBOL_TOKEN_LONGNAME_VEE => LongName_Vee,
        st::SYMBOL_TOKEN_LONGNAME_INTERSECTION => LongName_Intersection,
        st::SYMBOL_TOKEN_LONGNAME_UNION => LongName_Union,
        st::SYMBOL_TOKEN_LONGNAME_DIAMOND => LongName_Diamond,
        st::SYMBOL_TOKEN_LONGNAME_STAR => LongName_Star,
        st::SYMBOL_TOKEN_LONGNAME_LESSEQUALGREATER => LongName_LessEqualGreater,
        st::SYMBOL_TOKEN_LONGNAME_GREATEREQUALLESS => LongName_GreaterEqualLess,
        st::SYMBOL_TOKEN_LONGNAME_NOTPRECEDESSLANTEQUAL => LongName_NotPrecedesSlantEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTSUCCEEDSSLANTEQUAL => LongName_NotSucceedsSlantEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTSQUARESUBSETEQUAL => LongName_NotSquareSubsetEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTSQUARESUPERSETEQUAL => LongName_NotSquareSupersetEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTPRECEDESTILDE => LongName_NotPrecedesTilde,
        st::SYMBOL_TOKEN_LONGNAME_NOTSUCCEEDSTILDE => LongName_NotSucceedsTilde,
        st::SYMBOL_TOKEN_LONGNAME_NOTLEFTTRIANGLE => LongName_NotLeftTriangle,
        st::SYMBOL_TOKEN_LONGNAME_NOTRIGHTTRIANGLE => LongName_NotRightTriangle,
        st::SYMBOL_TOKEN_LONGNAME_NOTLEFTTRIANGLEEQUAL => LongName_NotLeftTriangleEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTRIGHTTRIANGLEEQUAL => LongName_NotRightTriangleEqual,
        st::SYMBOL_TOKEN_LONGNAME_LEFTCEILING => LongName_LeftCeiling,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTCEILING => LongName_RightCeiling,
        st::SYMBOL_TOKEN_LONGNAME_LEFTFLOOR => LongName_LeftFloor,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTFLOOR => LongName_RightFloor,
        st::SYMBOL_TOKEN_LONGNAME_CAP => LongName_Cap,
        st::SYMBOL_TOKEN_LONGNAME_CUP => LongName_Cup,
        st::SYMBOL_TOKEN_LONGNAME_LEFTANGLEBRACKET => LongName_LeftAngleBracket,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTANGLEBRACKET => LongName_RightAngleBracket,
        st::SYMBOL_TOKEN_LONGNAME_PERPENDICULAR => LongName_Perpendicular,
        st::SYMBOL_TOKEN_LONGNAME_LONGLEFTARROW => LongName_LongLeftArrow,
        st::SYMBOL_TOKEN_LONGNAME_LONGRIGHTARROW => LongName_LongRightArrow,
        st::SYMBOL_TOKEN_LONGNAME_LONGLEFTRIGHTARROW => LongName_LongLeftRightArrow,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLELONGLEFTARROW => LongName_DoubleLongLeftArrow,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLELONGRIGHTARROW => LongName_DoubleLongRightArrow,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLELONGLEFTRIGHTARROW => LongName_DoubleLongLeftRightArrow,
        st::SYMBOL_TOKEN_LONGNAME_UPARROWBAR => LongName_UpArrowBar,
        st::SYMBOL_TOKEN_LONGNAME_DOWNARROWBAR => LongName_DownArrowBar,
        st::SYMBOL_TOKEN_LONGNAME_LEFTRIGHTVECTOR => LongName_LeftRightVector,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTUPDOWNVECTOR => LongName_RightUpDownVector,
        st::SYMBOL_TOKEN_LONGNAME_DOWNLEFTRIGHTVECTOR => LongName_DownLeftRightVector,
        st::SYMBOL_TOKEN_LONGNAME_LEFTUPDOWNVECTOR => LongName_LeftUpDownVector,
        st::SYMBOL_TOKEN_LONGNAME_LEFTVECTORBAR => LongName_LeftVectorBar,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTVECTORBAR => LongName_RightVectorBar,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTUPVECTORBAR => LongName_RightUpVectorBar,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTDOWNVECTORBAR => LongName_RightDownVectorBar,
        st::SYMBOL_TOKEN_LONGNAME_DOWNLEFTVECTORBAR => LongName_DownLeftVectorBar,
        st::SYMBOL_TOKEN_LONGNAME_DOWNRIGHTVECTORBAR => LongName_DownRightVectorBar,
        st::SYMBOL_TOKEN_LONGNAME_LEFTUPVECTORBAR => LongName_LeftUpVectorBar,
        st::SYMBOL_TOKEN_LONGNAME_LEFTDOWNVECTORBAR => LongName_LeftDownVectorBar,
        st::SYMBOL_TOKEN_LONGNAME_LEFTTEEVECTOR => LongName_LeftTeeVector,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTTEEVECTOR => LongName_RightTeeVector,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTUPTEEVECTOR => LongName_RightUpTeeVector,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTDOWNTEEVECTOR => LongName_RightDownTeeVector,
        st::SYMBOL_TOKEN_LONGNAME_DOWNLEFTTEEVECTOR => LongName_DownLeftTeeVector,
        st::SYMBOL_TOKEN_LONGNAME_DOWNRIGHTTEEVECTOR => LongName_DownRightTeeVector,
        st::SYMBOL_TOKEN_LONGNAME_LEFTUPTEEVECTOR => LongName_LeftUpTeeVector,
        st::SYMBOL_TOKEN_LONGNAME_LEFTDOWNTEEVECTOR => LongName_LeftDownTeeVector,
        st::SYMBOL_TOKEN_LONGNAME_UPEQUILIBRIUM => LongName_UpEquilibrium,
        st::SYMBOL_TOKEN_LONGNAME_REVERSEUPEQUILIBRIUM => LongName_ReverseUpEquilibrium,
        st::SYMBOL_TOKEN_LONGNAME_ROUNDIMPLIES => LongName_RoundImplies,
        st::SYMBOL_TOKEN_LONGNAME_LEFTTRIANGLEBAR => LongName_LeftTriangleBar,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTTRIANGLEBAR => LongName_RightTriangleBar,
        st::SYMBOL_TOKEN_LONGNAME_EQUIVALENT => LongName_Equivalent,
        st::SYMBOL_TOKEN_LONGNAME_LESSSLANTEQUAL => LongName_LessSlantEqual,
        st::SYMBOL_TOKEN_LONGNAME_GREATERSLANTEQUAL => LongName_GreaterSlantEqual,
        st::SYMBOL_TOKEN_LONGNAME_NESTEDLESSLESS => LongName_NestedLessLess,
        st::SYMBOL_TOKEN_LONGNAME_NESTEDGREATERGREATER => LongName_NestedGreaterGreater,
        st::SYMBOL_TOKEN_LONGNAME_PRECEDESEQUAL => LongName_PrecedesEqual,
        st::SYMBOL_TOKEN_LONGNAME_SUCCEEDSEQUAL => LongName_SucceedsEqual,
        st::SYMBOL_TOKEN_LONGNAME_DOUBLELEFTTEE => LongName_DoubleLeftTee,
        st::SYMBOL_TOKEN_LONGNAME_LEFTDOUBLEBRACKET => LongName_LeftDoubleBracket,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTDOUBLEBRACKET => LongName_RightDoubleBracket,
        st::SYMBOL_TOKEN_LONGNAME_LEFTASSOCIATION => LongName_LeftAssociation,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTASSOCIATION => LongName_RightAssociation,
        st::SYMBOL_TOKEN_LONGNAME_TWOWAYRULE => LongName_TwoWayRule,
        st::SYMBOL_TOKEN_LONGNAME_PIECEWISE => LongName_Piecewise,
        st::SYMBOL_TOKEN_LONGNAME_IMPLICITPLUS => LongName_ImplicitPlus,
        st::SYMBOL_TOKEN_LONGNAME_AUTOLEFTMATCH => LongName_AutoLeftMatch,
        st::SYMBOL_TOKEN_LONGNAME_AUTORIGHTMATCH => LongName_AutoRightMatch,
        st::SYMBOL_TOKEN_LONGNAME_INVISIBLEPREFIXSCRIPTBASE => LongName_InvisiblePrefixScriptBase,
        st::SYMBOL_TOKEN_LONGNAME_INVISIBLEPOSTFIXSCRIPTBASE => LongName_InvisiblePostfixScriptBase,
        st::SYMBOL_TOKEN_LONGNAME_TRANSPOSE => LongName_Transpose,
        st::SYMBOL_TOKEN_LONGNAME_CONJUGATE => LongName_Conjugate,
        st::SYMBOL_TOKEN_LONGNAME_CONJUGATETRANSPOSE => LongName_ConjugateTranspose,
        st::SYMBOL_TOKEN_LONGNAME_HERMITIANCONJUGATE => LongName_HermitianConjugate,
        st::SYMBOL_TOKEN_LONGNAME_VERTICALBAR => LongName_VerticalBar,
        st::SYMBOL_TOKEN_LONGNAME_NOTVERTICALBAR => LongName_NotVerticalBar,
        st::SYMBOL_TOKEN_LONGNAME_DISTRIBUTED => LongName_Distributed,
        st::SYMBOL_TOKEN_LONGNAME_CONDITIONED => LongName_Conditioned,
        st::SYMBOL_TOKEN_LONGNAME_UNDIRECTEDEDGE => LongName_UndirectedEdge,
        st::SYMBOL_TOKEN_LONGNAME_DIRECTEDEDGE => LongName_DirectedEdge,
        st::SYMBOL_TOKEN_LONGNAME_CONTINUEDFRACTIONK => LongName_ContinuedFractionK,
        st::SYMBOL_TOKEN_LONGNAME_TENSORPRODUCT => LongName_TensorProduct,
        st::SYMBOL_TOKEN_LONGNAME_TENSORWEDGE => LongName_TensorWedge,
        st::SYMBOL_TOKEN_LONGNAME_PROBABILITYPR => LongName_ProbabilityPr,
        st::SYMBOL_TOKEN_LONGNAME_EXPECTATIONE => LongName_ExpectationE,
        st::SYMBOL_TOKEN_LONGNAME_PERMUTATIONPRODUCT => LongName_PermutationProduct,
        st::SYMBOL_TOKEN_LONGNAME_NOTEQUALTILDE => LongName_NotEqualTilde,
        st::SYMBOL_TOKEN_LONGNAME_NOTHUMPEQUAL => LongName_NotHumpEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTHUMPDOWNHUMP => LongName_NotHumpDownHump,
        st::SYMBOL_TOKEN_LONGNAME_NOTLEFTTRIANGLEBAR => LongName_NotLeftTriangleBar,
        st::SYMBOL_TOKEN_LONGNAME_NOTRIGHTTRIANGLEBAR => LongName_NotRightTriangleBar,
        st::SYMBOL_TOKEN_LONGNAME_NOTLESSLESS => LongName_NotLessLess,
        st::SYMBOL_TOKEN_LONGNAME_NOTNESTEDLESSLESS => LongName_NotNestedLessLess,
        st::SYMBOL_TOKEN_LONGNAME_NOTLESSSLANTEQUAL => LongName_NotLessSlantEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTGREATERGREATER => LongName_NotGreaterGreater,
        st::SYMBOL_TOKEN_LONGNAME_NOTNESTEDGREATERGREATER => LongName_NotNestedGreaterGreater,
        st::SYMBOL_TOKEN_LONGNAME_NOTGREATERSLANTEQUAL => LongName_NotGreaterSlantEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTPRECEDESEQUAL => LongName_NotPrecedesEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTSUCCEEDSEQUAL => LongName_NotSucceedsEqual,
        st::SYMBOL_TOKEN_LONGNAME_NOTSQUARESUBSET => LongName_NotSquareSubset,
        st::SYMBOL_TOKEN_LONGNAME_NOTSQUARESUPERSET => LongName_NotSquareSuperset,
        st::SYMBOL_TOKEN_LONGNAME_EQUAL => LongName_Equal,
        st::SYMBOL_TOKEN_LONGNAME_VERTICALSEPARATOR => LongName_VerticalSeparator,
        st::SYMBOL_TOKEN_LONGNAME_VECTORGREATER => LongName_VectorGreater,
        st::SYMBOL_TOKEN_LONGNAME_VECTORGREATEREQUAL => LongName_VectorGreaterEqual,
        st::SYMBOL_TOKEN_LONGNAME_VECTORLESS => LongName_VectorLess,
        st::SYMBOL_TOKEN_LONGNAME_VECTORLESSEQUAL => LongName_VectorLessEqual,
        st::SYMBOL_TOKEN_LONGNAME_LIMIT => LongName_Limit,
        st::SYMBOL_TOKEN_LONGNAME_MAXLIMIT => LongName_MaxLimit,
        st::SYMBOL_TOKEN_LONGNAME_MINLIMIT => LongName_MinLimit,
        st::SYMBOL_TOKEN_LONGNAME_CROSS => LongName_Cross,
        st::SYMBOL_TOKEN_LONGNAME_FUNCTION => LongName_Function,
        st::SYMBOL_TOKEN_LONGNAME_XNOR => LongName_Xnor,
        st::SYMBOL_TOKEN_LONGNAME_DISCRETESHIFT => LongName_DiscreteShift,
        st::SYMBOL_TOKEN_LONGNAME_DIFFERENCEDELTA => LongName_DifferenceDelta,
        st::SYMBOL_TOKEN_LONGNAME_DISCRETERATIO => LongName_DiscreteRatio,
        st::SYMBOL_TOKEN_LONGNAME_RULEDELAYED => LongName_RuleDelayed,
        st::SYMBOL_TOKEN_LONGNAME_SQUARE => LongName_Square,
        st::SYMBOL_TOKEN_LONGNAME_RULE => LongName_Rule,
        st::SYMBOL_TOKEN_LONGNAME_IMPLIES => LongName_Implies,
        st::SYMBOL_TOKEN_LONGNAME_SHORTRIGHTARROW => LongName_ShortRightArrow,
        st::SYMBOL_TOKEN_LONGNAME_SHORTLEFTARROW => LongName_ShortLeftArrow,
        st::SYMBOL_TOKEN_LONGNAME_SHORTUPARROW => LongName_ShortUpArrow,
        st::SYMBOL_TOKEN_LONGNAME_SHORTDOWNARROW => LongName_ShortDownArrow,
        st::SYMBOL_TOKEN_LONGNAME_APPLICATION => LongName_Application,
        st::SYMBOL_TOKEN_LONGNAME_LEFTBRACKETINGBAR => LongName_LeftBracketingBar,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTBRACKETINGBAR => LongName_RightBracketingBar,
        st::SYMBOL_TOKEN_LONGNAME_LEFTDOUBLEBRACKETINGBAR => LongName_LeftDoubleBracketingBar,
        st::SYMBOL_TOKEN_LONGNAME_RIGHTDOUBLEBRACKETINGBAR => LongName_RightDoubleBracketingBar,
        st::SYMBOL_TOKEN_LONGNAME_CAPITALDIFFERENTIALD => LongName_CapitalDifferentialD,
        st::SYMBOL_TOKEN_LONGNAME_DIFFERENTIALD => LongName_DifferentialD,
        st::SYMBOL_TOKEN_LONGNAME_INVISIBLECOMMA => LongName_InvisibleComma,
        st::SYMBOL_TOKEN_LONGNAME_INVISIBLEAPPLICATION => LongName_InvisibleApplication,
        st::SYMBOL_TOKEN_LONGNAME_LONGEQUAL => LongName_LongEqual,
        st::SYMBOL_TOKEN_COUNT => Count,
        _ => return None,
    };
