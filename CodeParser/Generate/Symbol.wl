...
symbols = Union[Flatten[Join[
  {Blank, BlankSequence, BlankNullSequence, ByteArray,
    ...
    Unset, Part, System`TypeSpecifier, System`VectorLess, System`VectorGreater,
    System`VectorLessEqual, System`VectorGreaterEqual,
    Whitespace, $Aborted},
  {CodeParser`InfixTilde, CodeParser`TernaryOptionalPattern},
  {CodeParser`Source},
  {CodeParser`LeafNode,
