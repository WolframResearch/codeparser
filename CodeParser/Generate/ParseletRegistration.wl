...
InfixOperatorToParselet[Token`Slash] = BinaryOperatorParselet[Token`Slash, Precedence`Slash]
InfixOperatorToParselet[Token`Caret] = BinaryOperatorParselet[Token`Caret, Precedence`Caret]
InfixOperatorToParselet[Token`CaretEqual] = BinaryOperatorParselet[Token`CaretEqual, Precedence`CaretEqual]
InfixOperatorToParselet[Token`CaretColonEqual] = BinaryOperatorParselet[Token`CaretColonEqual, Precedence`CaretColonEqual]
InfixOperatorToParselet[Token`SlashAt] = BinaryOperatorParselet[Token`SlashAt, Precedence`SlashAt]
InfixOperatorToParselet[Token`MinusGreater] = BinaryOperatorParselet[Token`MinusGreater, Precedence`MinusGreater]
InfixOperatorToParselet[Token`AtAt] = BinaryOperatorParselet[Token`AtAt, Precedence`AtAt]
InfixOperatorToParselet[Token`SlashSemi] = BinaryOperatorParselet[Token`SlashSemi, Precedence`SlashSemi]
InfixOperatorToParselet[Token`SlashDot] = BinaryOperatorParselet[Token`SlashDot, Precedence`SlashDot]
InfixOperatorToParselet[Token`ColonGreater] = BinaryOperatorParselet[Token`ColonGreater, Precedence`ColonGreater]
InfixOperatorToParselet[Token`SlashSlashDot] = BinaryOperatorParselet[Token`SlashSlashDot, Precedence`SlashSlashDot]
InfixOperatorToParselet[Token`PlusEqual] = BinaryOperatorParselet[Token`PlusEqual, Precedence`PlusEqual]
InfixOperatorToParselet[Token`StarEqual] = BinaryOperatorParselet[Token`StarEqual, Precedence`StarEqual]
InfixOperatorToParselet[Token`MinusEqual] = BinaryOperatorParselet[Token`MinusEqual, Precedence`MinusEqual]
InfixOperatorToParselet[Token`SlashEqual] = BinaryOperatorParselet[Token`SlashEqual, Precedence`SlashEqual]
InfixOperatorToParselet[Token`LessMinusGreater] = BinaryOperatorParselet[Token`LessMinusGreater, Precedence`LessMinusGreater]
InfixOperatorToParselet[Token`SlashSlashAt] = BinaryOperatorParselet[Token`SlashSlashAt, Precedence`SlashSlashAt]
...
InfixOperatorToParselet[Token`LongName`Implies] = BinaryOperatorParselet[Token`LongName`Implies, Precedence`LongName`Implies]
InfixOperatorToParselet[Token`LongName`RoundImplies] = BinaryOperatorParselet[Token`LongName`RoundImplies, Precedence`LongName`RoundImplies]
InfixOperatorToParselet[Token`LongName`PlusMinus] = BinaryOperatorParselet[Token`LongName`PlusMinus, Precedence`Infix`LongName`PlusMinus]
InfixOperatorToParselet[Token`LongName`DirectedEdge] = BinaryOperatorParselet[Token`LongName`DirectedEdge, Precedence`LongName`DirectedEdge]
InfixOperatorToParselet[Token`LongName`Rule] = BinaryOperatorParselet[Token`LongName`Rule, Precedence`LongName`Rule]
InfixOperatorToParselet[Token`LongName`RuleDelayed] = BinaryOperatorParselet[Token`LongName`RuleDelayed, Precedence`LongName`RuleDelayed]
InfixOperatorToParselet[Token`LongName`UndirectedEdge] = BinaryOperatorParselet[Token`LongName`UndirectedEdge, Precedence`LongName`UndirectedEdge]
InfixOperatorToParselet[Token`LongName`Function] = BinaryOperatorParselet[Token`LongName`Function, Precedence`LongName`Function]
InfixOperatorToParselet[Token`LongName`MinusPlus] = BinaryOperatorParselet[Token`LongName`MinusPlus, Precedence`Infix`LongName`MinusPlus]
InfixOperatorToParselet[Token`LongName`TwoWayRule] = BinaryOperatorParselet[Token`LongName`TwoWayRule, Precedence`LongName`TwoWayRule]
InfixOperatorToParselet[Token`LongName`InvisibleApplication] = BinaryOperatorParselet[Token`LongName`InvisibleApplication, Precedence`LongName`InvisibleApplication]
InfixOperatorToParselet[Token`LongName`CircleMinus] = BinaryOperatorParselet[Token`LongName`CircleMinus, Precedence`LongName`CircleMinus]
InfixOperatorToParselet[Token`LongName`SuchThat] = BinaryOperatorParselet[Token`LongName`SuchThat, Precedence`LongName`SuchThat]
InfixOperatorToParselet[Token`LongName`Perpendicular] = BinaryOperatorParselet[Token`LongName`Perpendicular, Precedence`LongName`Perpendicular]
InfixOperatorToParselet[Token`LongName`Because] = BinaryOperatorParselet[Token`LongName`Because, Precedence`LongName`Because]
InfixOperatorToParselet[Token`LongName`Therefore] = BinaryOperatorParselet[Token`LongName`Therefore, Precedence`LongName`Therefore]
InfixOperatorToParselet[Token`LongName`RightTee] = BinaryOperatorParselet[Token`LongName`RightTee, Precedence`LongName`RightTee]
InfixOperatorToParselet[Token`LongName`LeftTee] = BinaryOperatorParselet[Token`LongName`LeftTee, Precedence`LongName`LeftTee]
InfixOperatorToParselet[Token`LongName`DoubleRightTee] = BinaryOperatorParselet[Token`LongName`DoubleRightTee, Precedence`LongName`DoubleRightTee]
InfixOperatorToParselet[Token`LongName`DoubleLeftTee] = BinaryOperatorParselet[Token`LongName`DoubleLeftTee, Precedence`LongName`DoubleLeftTee]
InfixOperatorToParselet[Token`LongName`UpTee] = BinaryOperatorParselet[Token`LongName`UpTee, Precedence`LongName`UpTee]
InfixOperatorToParselet[Token`LongName`DownTee] = BinaryOperatorParselet[Token`LongName`DownTee, Precedence`LongName`DownTee]
...
formatInfix[BinaryOperatorParselet[tok_, precedence_]] := "new BinaryOperatorParselet(" <> toGlobal[tok] <> ", " <> toGlobal[precedence] <> ")"
