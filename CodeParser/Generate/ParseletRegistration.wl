...
InfixOperatorToParselet[Token`Slash] = BinaryOperatorParselet[Token`Slash, Precedence`Slash, Associativity`NonRight]
...
InfixOperatorToParselet[Token`SlashSemi] = BinaryOperatorParselet[Token`SlashSemi, Precedence`SlashSemi, Associativity`NonRight]
InfixOperatorToParselet[Token`SlashDot] = BinaryOperatorParselet[Token`SlashDot, Precedence`SlashDot, Associativity`NonRight]
...
InfixOperatorToParselet[Token`SlashSlashDot] = BinaryOperatorParselet[Token`SlashSlashDot, Precedence`SlashSlashDot, Associativity`NonRight]
...
InfixOperatorToParselet[Token`SlashSlash] = BinaryOperatorParselet[Token`SlashSlash, Precedence`SlashSlash, Associativity`NonRight]
...
InfixOperatorToParselet[Token`Question] = BinaryOperatorParselet[Token`Question, Precedence`Infix`Question, Associativity`NonRight]
InfixOperatorToParselet[Token`LongName`Divide] = BinaryOperatorParselet[Token`LongName`Divide, Precedence`LongName`Divide, Associativity`NonRight]
InfixOperatorToParselet[Token`LongName`DivisionSlash] = BinaryOperatorParselet[Token`LongName`DivisionSlash, Precedence`LongName`DivisionSlash, Associativity`NonRight]
...
InfixOperatorToParselet[Token`LongName`PlusMinus] = BinaryOperatorParselet[Token`LongName`PlusMinus, Precedence`Infix`LongName`PlusMinus, Associativity`NonRight]
...
InfixOperatorToParselet[Token`LongName`MinusPlus] = BinaryOperatorParselet[Token`LongName`MinusPlus, Precedence`Infix`LongName`MinusPlus, Associativity`NonRight]
...
InfixOperatorToParselet[Token`LongName`CircleMinus] = BinaryOperatorParselet[Token`LongName`CircleMinus, Precedence`LongName`CircleMinus, Associativity`NonRight]
...
InfixOperatorToParselet[Token`LongName`Perpendicular] = BinaryOperatorParselet[Token`LongName`Perpendicular, Precedence`LongName`Perpendicular, Associativity`NonRight]
InfixOperatorToParselet[Token`LongName`Because] = BinaryOperatorParselet[Token`LongName`Because, Precedence`LongName`Because, Associativity`NonRight]
...
InfixOperatorToParselet[Token`LongName`LeftTee] = BinaryOperatorParselet[Token`LongName`LeftTee, Precedence`LongName`LeftTee, Associativity`NonRight]
...
InfixOperatorToParselet[Token`LongName`DoubleLeftTee] = BinaryOperatorParselet[Token`LongName`DoubleLeftTee, Precedence`LongName`DoubleLeftTee, Associativity`NonRight]
InfixOperatorToParselet[Token`LongName`UpTee] = BinaryOperatorParselet[Token`LongName`UpTee, Precedence`LongName`UpTee, Associativity`NonRight]
InfixOperatorToParselet[Token`LongName`DownTee] = BinaryOperatorParselet[Token`LongName`DownTee, Precedence`LongName`DownTee, Associativity`NonRight]
