...
Module[{handledChildren, aggregatedChildren},
  ...
  Switch[aggregatedChildren,
    ...
    *)
    ...
    {_, LeafNode[Token`LongName`SuchThat, _, _], _}, BinaryNode[SuchThat, handledChildren, <|Source->Append[pos, 1]|>],
    {_, LeafNode[Token`LongName`Therefore, _, _], _}, BinaryNode[Therefore, handledChildren, <|Source->Append[pos, 1]|>],
