...
Module[{src, cst, func, trivia, srcPosMap},
  ...
  func = SourceMemberQ[src];
    trivia = Cases[cst, LeafNode[Whitespace | Token`ToplevelNewline | Token`InternalNewline | Token`Comment | Token`LineContinuation, _, KeyValuePattern[Source -> src_?func]], Infinity];
