...
*)
normalizeTokens[astIn_] :=
	Module[{ast, data, tokStartLocs, lineContinuations, embeddedNewlines, grouped, poss, tuples, mapSpecs},

		ast = astIn;

		data = ast[[3]];

		If[KeyExistsQ[data, "LineContinuations"] || KeyExistsQ[data, "EmbeddedNewlines"],
			...
			*)
			...
			If[KeyExistsQ[data, "LineContinuations"],
				...
				ast = MapAt[removeLineContinuations, ast, mapSpecs];
			...
			If[KeyExistsQ[data, "EmbeddedNewlines"],
				...
				ast = MapAt[convertEmbeddedNewlines, ast, mapSpecs];
...
*)
removeLineContinuations[LeafNode[tag_, str_, data_]] :=
...
*)
convertEmbeddedNewlines[LeafNode[tag_, str_, data_]] :=
