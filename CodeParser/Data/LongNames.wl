...
Range 0x2100
*)
"ScriptG" -> {LetterlikeCharacter, 16^^210a, <| "ASCIIReplacements" -> {"g"}  |>},
...
"HBar" -> {LetterlikeCharacter, 16^^210f, <| "ASCIIReplacements" -> {"h"} |>},
...
"ScriptL" -> {LetterlikeCharacter, 16^^2113, <| "ASCIIReplacements" -> {"l"} |>},
...
"ScriptE" -> {LetterlikeCharacter, 16^^212f, <| "ASCIIReplacements" -> {"e"} |>},
...
"ScriptO" -> {LetterlikeCharacter, 16^^2134, <| "ASCIIReplacements" -> {"o"} |>},
