...
"CapitalADoubleDot" -> {LetterlikeCharacter, 16^^00c4, <| "ASCIIReplacements" -> {"A\"", "A"} |>},
...
"CapitalUDoubleDot" -> {LetterlikeCharacter, 16^^00dc, <| "ASCIIReplacements" -> {"U\"", "U"} |>},
...
"ADoubleDot" -> {LetterlikeCharacter, 16^^00e4, <| "ASCIIReplacements" -> {"a\"", "a"} |>},
...
"UDoubleDot" -> {LetterlikeCharacter, 16^^00fc, <| "ASCIIReplacements" -> {"u\"", "u"} |>},
