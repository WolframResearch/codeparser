...
pub const CODEPOINT_LONGNAME_LAPLACIAN: CodePoint = CodePoint::Char('\u{2206}');
...
pub const CODEPOINT_LONGNAME_GRADIENT: CodePoint = CodePoint::Char('\u{f3d6}');
pub const CODEPOINT_LONGNAME_DIVERGENCE: CodePoint = CodePoint::Char('\u{f3d7}');
pub const CODEPOINT_LONGNAME_CURL: CodePoint = CodePoint::Char('\u{f3d8}');
...
"Coproduct", "Copyright", "CounterClockwiseContourIntegral", "Cross", "CubeRoot", "Cup", "CupCap", "Curl", 
"CurlyCapitalUpsilon", "CurlyEpsilon", "CurlyKappa", "CurlyPhi", "CurlyPi", "CurlyRho", "CurlyTheta", "Currency", 
"DHacek", "Dagger", "Dalet", "Dash", "Degree", "Del", "DeleteKey", "Delta", "DescendingEllipsis", "Diameter", "Diamond",
 "DiamondSuit", "DifferenceDelta", "DifferentialD", "Digamma", "DirectedEdge", "DiscreteRatio", "DiscreteShift", 
"DiscretionaryHyphen", "DiscretionaryLineSeparator", "DiscretionaryPageBreakAbove", "DiscretionaryPageBreakBelow", 
"DiscretionaryParagraphSeparator", "Distributed", "Divergence", "Divide", "Divides", "DivisionSlash", "DotEqual", 
"DotlessI", "DotlessJ", "DottedSquare", "DoubleContourIntegral", "DoubleDagger", "DoubleDot", "DoubleDownArrow", 
"DoubleLeftArrow", "DoubleLeftRightArrow", "DoubleLeftTee", "DoubleLongLeftArrow", "DoubleLongLeftRightArrow", 
"DoubleLongRightArrow", "DoublePrime", "DoubleRightArrow", "DoubleRightTee", "DoubleStruckA", "DoubleStruckB", 
"DoubleStruckC", "DoubleStruckCapitalA", "DoubleStruckCapitalB", "DoubleStruckCapitalC", "DoubleStruckCapitalD", 
"DoubleStruckCapitalE", "DoubleStruckCapitalF", "DoubleStruckCapitalG", "DoubleStruckCapitalH", "DoubleStruckCapitalI", 
"DoubleStruckCapitalJ", "DoubleStruckCapitalK", "DoubleStruckCapitalL", "DoubleStruckCapitalM", "DoubleStruckCapitalN", 
"DoubleStruckCapitalO", "DoubleStruckCapitalP", "DoubleStruckCapitalQ", "DoubleStruckCapitalR", "DoubleStruckCapitalS", 
"DoubleStruckCapitalT", "DoubleStruckCapitalU", "DoubleStruckCapitalV", "DoubleStruckCapitalW", "DoubleStruckCapitalX", 
"DoubleStruckCapitalY", "DoubleStruckCapitalZ", "DoubleStruckD", "DoubleStruckE", "DoubleStruckEight", "DoubleStruckF", 
"DoubleStruckFive", "DoubleStruckFour", "DoubleStruckG", "DoubleStruckH", "DoubleStruckI", "DoubleStruckJ", 
"DoubleStruckK", "DoubleStruckL", "DoubleStruckM", "DoubleStruckN", "DoubleStruckNine", "DoubleStruckO", 
"DoubleStruckOne", "DoubleStruckP", "DoubleStruckQ", "DoubleStruckR", "DoubleStruckS", "DoubleStruckSeven", 
"DoubleStruckSix", "DoubleStruckT", "DoubleStruckThree", "DoubleStruckTwo", "DoubleStruckU", "DoubleStruckV", 
"DoubleStruckW", "DoubleStruckX", "DoubleStruckY", "DoubleStruckZ", "DoubleStruckZero", "DoubleUpArrow", 
"DoubleUpDownArrow", "DoubleVerticalBar", "DoubledGamma", "DoubledPi", "DownArrow", "DownArrowBar", "DownArrowUpArrow", 
"DownBreve", "DownExclamation", "DownLeftRightVector", "DownLeftTeeVector", "DownLeftVector", "DownLeftVectorBar", 
"DownPointer", "DownQuestion", "DownRightTeeVector", "DownRightVector", "DownRightVectorBar", "DownTee", "DownTeeArrow",
 "EAcute", "EBar", "ECup", "EDoubleDot", "EGrave", "EHacek", "EHat", "Earth", "EighthNote", "Element", "Ellipsis", 
"EmptyCircle", "EmptyDiamond", "EmptyDownTriangle", "EmptyRectangle", "EmptySet", "EmptySmallCircle", "EmptySmallSquare"
, "EmptySquare", "EmptyUpTriangle", "EmptyVerySmallSquare", "EnterKey", "EntityEnd", "EntityStart", "Epsilon", "Equal", 
"EqualTilde", "Equilibrium", "Equivalent", "ErrorIndicator", "EscapeKey", "Eta", "Eth", "Euro", "Exists", "ExpectationE"
...
, "GothicW", "GothicX", "GothicY", "GothicZ", "GothicZero", "Gradient", "GrayCircle", "GraySquare", "GreaterEqual", 
...
"Kappa", "KernelIcon", "KeyBar", "Koppa", "LSlash", "Lambda", "Laplacian", "LastPage", "LeftAngleBracket", "LeftArrow", 
...
CODEPOINT_LONGNAME_CUBEROOT, CODEPOINT_LONGNAME_CUP, CODEPOINT_LONGNAME_CUPCAP, CODEPOINT_LONGNAME_CURL, 
CODEPOINT_LONGNAME_CURLYCAPITALUPSILON, CODEPOINT_LONGNAME_CURLYEPSILON, CODEPOINT_LONGNAME_CURLYKAPPA, 
CODEPOINT_LONGNAME_CURLYPHI, CODEPOINT_LONGNAME_CURLYPI, CODEPOINT_LONGNAME_CURLYRHO, CODEPOINT_LONGNAME_CURLYTHETA, 
CODEPOINT_LONGNAME_CURRENCY, CODEPOINT_LONGNAME_DHACEK, CODEPOINT_LONGNAME_DAGGER, CODEPOINT_LONGNAME_DALET, 
CODEPOINT_LONGNAME_DASH, CODEPOINT_LONGNAME_DEGREE, CODEPOINT_LONGNAME_DEL, CODEPOINT_LONGNAME_DELETEKEY, 
CODEPOINT_LONGNAME_DELTA, CODEPOINT_LONGNAME_DESCENDINGELLIPSIS, CODEPOINT_LONGNAME_DIAMETER, CODEPOINT_LONGNAME_DIAMOND
, CODEPOINT_LONGNAME_DIAMONDSUIT, CODEPOINT_LONGNAME_DIFFERENCEDELTA, CODEPOINT_LONGNAME_DIFFERENTIALD, 
CODEPOINT_LONGNAME_DIGAMMA, CODEPOINT_LONGNAME_DIRECTEDEDGE, CODEPOINT_LONGNAME_DISCRETERATIO, 
CODEPOINT_LONGNAME_DISCRETESHIFT, CODEPOINT_LONGNAME_DISCRETIONARYHYPHEN, CODEPOINT_LONGNAME_DISCRETIONARYLINESEPARATOR,
 CODEPOINT_LONGNAME_DISCRETIONARYPAGEBREAKABOVE, CODEPOINT_LONGNAME_DISCRETIONARYPAGEBREAKBELOW, 
CODEPOINT_LONGNAME_DISCRETIONARYPARAGRAPHSEPARATOR, CODEPOINT_LONGNAME_DISTRIBUTED, CODEPOINT_LONGNAME_DIVERGENCE, 
CODEPOINT_LONGNAME_DIVIDE, CODEPOINT_LONGNAME_DIVIDES, CODEPOINT_LONGNAME_DIVISIONSLASH, CODEPOINT_LONGNAME_DOTEQUAL, 
CODEPOINT_LONGNAME_DOTLESSI, CODEPOINT_LONGNAME_DOTLESSJ, CODEPOINT_LONGNAME_DOTTEDSQUARE, 
CODEPOINT_LONGNAME_DOUBLECONTOURINTEGRAL, CODEPOINT_LONGNAME_DOUBLEDAGGER, CODEPOINT_LONGNAME_DOUBLEDOT, 
CODEPOINT_LONGNAME_DOUBLEDOWNARROW, CODEPOINT_LONGNAME_DOUBLELEFTARROW, CODEPOINT_LONGNAME_DOUBLELEFTRIGHTARROW, 
CODEPOINT_LONGNAME_DOUBLELEFTTEE, CODEPOINT_LONGNAME_DOUBLELONGLEFTARROW, CODEPOINT_LONGNAME_DOUBLELONGLEFTRIGHTARROW, 
...
CODEPOINT_LONGNAME_GOTHICY, CODEPOINT_LONGNAME_GOTHICZ, CODEPOINT_LONGNAME_GOTHICZERO, CODEPOINT_LONGNAME_GRADIENT, 
CODEPOINT_LONGNAME_GRAYCIRCLE, CODEPOINT_LONGNAME_GRAYSQUARE, CODEPOINT_LONGNAME_GREATEREQUAL, 
CODEPOINT_LONGNAME_GREATEREQUALLESS, CODEPOINT_LONGNAME_GREATERFULLEQUAL, CODEPOINT_LONGNAME_GREATERGREATER, 
CODEPOINT_LONGNAME_GREATERLESS, CODEPOINT_LONGNAME_GREATERSLANTEQUAL, CODEPOINT_LONGNAME_GREATERTILDE, 
CODEPOINT_LONGNAME_HBAR, CODEPOINT_LONGNAME_HACEK, CODEPOINT_LONGNAME_HAPPYSMILEY, CODEPOINT_LONGNAME_HEARTSUIT, 
CODEPOINT_LONGNAME_HERMITIANCONJUGATE, CODEPOINT_LONGNAME_HORIZONTALLINE, CODEPOINT_LONGNAME_HUMPDOWNHUMP, 
CODEPOINT_LONGNAME_HUMPEQUAL, CODEPOINT_LONGNAME_HYPHEN, CODEPOINT_LONGNAME_IACUTE, CODEPOINT_LONGNAME_ICUP, 
CODEPOINT_LONGNAME_IDOUBLEDOT, CODEPOINT_LONGNAME_IGRAVE, CODEPOINT_LONGNAME_IHAT, CODEPOINT_LONGNAME_IMAGINARYI, 
CODEPOINT_LONGNAME_IMAGINARYJ, CODEPOINT_LONGNAME_IMPLICITPLUS, CODEPOINT_LONGNAME_IMPLIES, 
CODEPOINT_LONGNAME_INDENTINGNEWLINE, CODEPOINT_LONGNAME_INFINITY, CODEPOINT_LONGNAME_INLINEPART, 
CODEPOINT_LONGNAME_INTEGRAL, CODEPOINT_LONGNAME_INTERSECTION, CODEPOINT_LONGNAME_INVISIBLEAPPLICATION, 
CODEPOINT_LONGNAME_INVISIBLECOMMA, CODEPOINT_LONGNAME_INVISIBLEPOSTFIXSCRIPTBASE, 
CODEPOINT_LONGNAME_INVISIBLEPREFIXSCRIPTBASE, CODEPOINT_LONGNAME_INVISIBLESPACE, CODEPOINT_LONGNAME_INVISIBLETIMES, 
CODEPOINT_LONGNAME_IOTA, CODEPOINT_LONGNAME_JUPITER, CODEPOINT_LONGNAME_KAPPA, CODEPOINT_LONGNAME_KERNELICON, 
CODEPOINT_LONGNAME_KEYBAR, CODEPOINT_LONGNAME_KOPPA, CODEPOINT_LONGNAME_LSLASH, CODEPOINT_LONGNAME_LAMBDA, 
CODEPOINT_LONGNAME_LAPLACIAN, CODEPOINT_LONGNAME_LASTPAGE, CODEPOINT_LONGNAME_LEFTANGLEBRACKET, 
CODEPOINT_LONGNAME_LEFTARROW, CODEPOINT_LONGNAME_LEFTARROWBAR, CODEPOINT_LONGNAME_LEFTARROWRIGHTARROW, 
CODEPOINT_LONGNAME_LEFTASSOCIATION, CODEPOINT_LONGNAME_LEFTBRACKETINGBAR, CODEPOINT_LONGNAME_LEFTCEILING, 
CODEPOINT_LONGNAME_LEFTDOUBLEBRACKET, CODEPOINT_LONGNAME_LEFTDOUBLEBRACKETINGBAR, CODEPOINT_LONGNAME_LEFTDOWNTEEVECTOR, 
CODEPOINT_LONGNAME_LEFTDOWNVECTOR, CODEPOINT_LONGNAME_LEFTDOWNVECTORBAR, CODEPOINT_LONGNAME_LEFTFLOOR, 
CODEPOINT_LONGNAME_LEFTGUILLEMET, CODEPOINT_LONGNAME_LEFTMODIFIED, CODEPOINT_LONGNAME_LEFTPOINTER, 
CODEPOINT_LONGNAME_LEFTRIGHTARROW, CODEPOINT_LONGNAME_LEFTRIGHTVECTOR, CODEPOINT_LONGNAME_LEFTSKELETON, 
CODEPOINT_LONGNAME_LEFTTEE, CODEPOINT_LONGNAME_LEFTTEEARROW, CODEPOINT_LONGNAME_LEFTTEEVECTOR, 
CODEPOINT_LONGNAME_LEFTTRIANGLE, CODEPOINT_LONGNAME_LEFTTRIANGLEBAR, CODEPOINT_LONGNAME_LEFTTRIANGLEEQUAL, 
CODEPOINT_LONGNAME_LEFTUPDOWNVECTOR, CODEPOINT_LONGNAME_LEFTUPTEEVECTOR, CODEPOINT_LONGNAME_LEFTUPVECTOR, 
CODEPOINT_LONGNAME_LEFTUPVECTORBAR, CODEPOINT_LONGNAME_LEFTVECTOR, CODEPOINT_LONGNAME_LEFTVECTORBAR, 
CODEPOINT_LONGNAME_LEOSIGN, CODEPOINT_LONGNAME_LESSEQUAL, CODEPOINT_LONGNAME_LESSEQUALGREATER, 
CODEPOINT_LONGNAME_LESSFULLEQUAL, CODEPOINT_LONGNAME_LESSGREATER, CODEPOINT_LONGNAME_LESSLESS, 
CODEPOINT_LONGNAME_LESSSLANTEQUAL, CODEPOINT_LONGNAME_LESSTILDE, CODEPOINT_LONGNAME_LETTERSPACE, 
CODEPOINT_LONGNAME_LIBRASIGN, CODEPOINT_LONGNAME_LIGHTBULB, CODEPOINT_LONGNAME_LIMIT, CODEPOINT_LONGNAME_LINESEPARATOR, 
CODEPOINT_LONGNAME_LONGDASH, CODEPOINT_LONGNAME_LONGEQUAL, CODEPOINT_LONGNAME_LONGLEFTARROW, 
CODEPOINT_LONGNAME_LONGLEFTRIGHTARROW, CODEPOINT_LONGNAME_LONGRIGHTARROW, CODEPOINT_LONGNAME_LOWERLEFTARROW, 
CODEPOINT_LONGNAME_LOWERRIGHTARROW, CODEPOINT_LONGNAME_MARS, CODEPOINT_LONGNAME_MATHEMATICAICON, 
CODEPOINT_LONGNAME_MAXLIMIT, CODEPOINT_LONGNAME_MEASUREDANGLE, CODEPOINT_LONGNAME_MEDIUMSPACE, 
CODEPOINT_LONGNAME_MERCURY, CODEPOINT_LONGNAME_MHO, CODEPOINT_LONGNAME_MICRO, CODEPOINT_LONGNAME_MINLIMIT, 
CODEPOINT_LONGNAME_MINUS, CODEPOINT_LONGNAME_MINUSPLUS, CODEPOINT_LONGNAME_MOD1KEY, CODEPOINT_LONGNAME_MOD2KEY, 
CODEPOINT_LONGNAME_MOON, CODEPOINT_LONGNAME_MU, CODEPOINT_LONGNAME_NHACEK, CODEPOINT_LONGNAME_NTILDE, 
CODEPOINT_LONGNAME_NAND, CODEPOINT_LONGNAME_NATURAL, CODEPOINT_LONGNAME_NEGATIVEMEDIUMSPACE, 
...
CODEPOINT_LONGNAME_EMPTYSET, CODEPOINT_LONGNAME_LAPLACIAN, CODEPOINT_LONGNAME_DEL, CODEPOINT_LONGNAME_ELEMENT, 
CODEPOINT_LONGNAME_NOTELEMENT, CODEPOINT_LONGNAME_REVERSEELEMENT, CODEPOINT_LONGNAME_NOTREVERSEELEMENT, 
CODEPOINT_LONGNAME_SUCHTHAT, CODEPOINT_LONGNAME_PRODUCT, CODEPOINT_LONGNAME_COPRODUCT, CODEPOINT_LONGNAME_SUM, 
CODEPOINT_LONGNAME_MINUS, CODEPOINT_LONGNAME_MINUSPLUS, CODEPOINT_LONGNAME_DIVISIONSLASH, CODEPOINT_LONGNAME_BACKSLASH, 
...
CODEPOINT_LONGNAME_GRADIENT, CODEPOINT_LONGNAME_DIVERGENCE, CODEPOINT_LONGNAME_CURL, 
...
"RightArrowBar", "DownArrowUpArrow", "ForAll", "PartialD", "Exists", "NotExists", "EmptySet", "Laplacian", "Del", 
"Element", "NotElement", "ReverseElement", "NotReverseElement", "SuchThat", "Product", "Coproduct", "Sum", "Minus", 
"MinusPlus", "DivisionSlash", "Backslash", "SmallCircle", "Sqrt", "CubeRoot", "Proportional", "Infinity", "RightAngle", 
"Angle", "MeasuredAngle", "SphericalAngle", "Divides", "DoubleVerticalBar", "NotDoubleVerticalBar", "And", "Or", 
"Integral", "ContourIntegral", "DoubleContourIntegral", "ClockwiseContourIntegral", "CounterClockwiseContourIntegral", 
"Therefore", "Because", "Colon", "Proportion", "Tilde", "VerticalTilde", "NotTilde", "EqualTilde", "TildeEqual", 
"NotTildeEqual", "TildeFullEqual", "NotTildeFullEqual", "TildeTilde", "NotTildeTilde", "CupCap", "HumpDownHump", 
"HumpEqual", "DotEqual", "NotEqual", "Congruent", "NotCongruent", "LessEqual", "GreaterEqual", "LessFullEqual", 
"GreaterFullEqual", "NotLessFullEqual", "NotGreaterFullEqual", "LessLess", "GreaterGreater", "NotCupCap", "NotLess", 
"NotGreater", "NotLessEqual", "NotGreaterEqual", "LessTilde", "GreaterTilde", "NotLessTilde", "NotGreaterTilde", 
"LessGreater", "GreaterLess", "NotLessGreater", "NotGreaterLess", "Precedes", "Succeeds", "PrecedesSlantEqual", 
"SucceedsSlantEqual", "PrecedesTilde", "SucceedsTilde", "NotPrecedes", "NotSucceeds", "Subset", "Superset", "NotSubset",
 "NotSuperset", "SubsetEqual", "SupersetEqual", "NotSubsetEqual", "NotSupersetEqual", "UnionPlus", "SquareSubset", 
"SquareSuperset", "SquareSubsetEqual", "SquareSupersetEqual", "SquareIntersection", "SquareUnion", "CirclePlus", 
"CircleMinus", "CircleTimes", "CircleDot", "RightTee", "LeftTee", "DownTee", "UpTee", "DoubleRightTee", "LeftTriangle", 
"RightTriangle", "LeftTriangleEqual", "RightTriangleEqual", "Xor", "Nand", "Nor", "Wedge", "Vee", "Intersection", 
"Union", "Diamond", "Star", "LessEqualGreater", "GreaterEqualLess", "NotPrecedesSlantEqual", "NotSucceedsSlantEqual", 
"NotSquareSubsetEqual", "NotSquareSupersetEqual", "NotPrecedesTilde", "NotSucceedsTilde", "NotLeftTriangle", 
"NotRightTriangle", "NotLeftTriangleEqual", "NotRightTriangleEqual", "VerticalEllipsis", "CenterEllipsis", 
"AscendingEllipsis", "DescendingEllipsis", "Diameter", "LeftCeiling", "RightCeiling", "LeftFloor", "RightFloor", 
"CloverLeaf", "WatchIcon", "Cap", "Cup", "LeftAngleBracket", "RightAngleBracket", "OverBracket", "UnderBracket", 
"SpaceIndicator", "HorizontalLine", "VerticalLine", "FilledSquare", "EmptySquare", "FilledVerySmallSquare", 
"EmptyVerySmallSquare", "FilledRectangle", "EmptyRectangle", "FilledUpTriangle", "EmptyUpTriangle", "UpPointer", 
"FilledRightTriangle", "RightPointer", "FilledDownTriangle", "EmptyDownTriangle", "DownPointer", "FilledLeftTriangle", 
"LeftPointer", "FilledDiamond", "EmptyDiamond", "EmptyCircle", "FilledCircle", "EmptySmallCircle", "EmptySmallSquare", 
"FilledSmallSquare", "FivePointedStar", "Sun", "CheckmarkedBox", "CheckedBox", "SadSmiley", "HappySmiley", "Moon", 
"Mercury", "Venus", "Mars", "Jupiter", "Saturn", "Neptune", "Pluto", "AriesSign", "TaurusSign", "GeminiSign", 
"CancerSign", "LeoSign", "VirgoSign", "LibraSign", "ScorpioSign", "SagittariusSign", "CapricornSign", "AquariusSign", 
"PiscesSign", "WhiteKing", "WhiteQueen", "WhiteRook", "WhiteBishop", "WhiteKnight", "WhitePawn", "BlackKing", 
"BlackQueen", "BlackRook", "BlackBishop", "BlackKnight", "BlackPawn", "SpadeSuit", "HeartSuit", "DiamondSuit", 
"ClubSuit", "QuarterNote", "EighthNote", "BeamedEighthNote", "BeamedSixteenthNote", "Flat", "Natural", "Sharp", "Uranus"
, "Checkmark", "SixPointedStar", "Perpendicular", "LongLeftArrow", "LongRightArrow", "LongLeftRightArrow", 
"DoubleLongLeftArrow", "DoubleLongRightArrow", "DoubleLongLeftRightArrow", "UpArrowBar", "DownArrowBar", 
"LeftRightVector", "RightUpDownVector", "DownLeftRightVector", "LeftUpDownVector", "LeftVectorBar", "RightVectorBar", 
"RightUpVectorBar", "RightDownVectorBar", "DownLeftVectorBar", "DownRightVectorBar", "LeftUpVectorBar", 
"LeftDownVectorBar", "LeftTeeVector", "RightTeeVector", "RightUpTeeVector", "RightDownTeeVector", "DownLeftTeeVector", 
"DownRightTeeVector", "LeftUpTeeVector", "LeftDownTeeVector", "UpEquilibrium", "ReverseUpEquilibrium", "RoundImplies", 
"LeftTriangleBar", "RightTriangleBar", "Equivalent", "LessSlantEqual", "GreaterSlantEqual", "NestedLessLess", 
"NestedGreaterGreater", "PrecedesEqual", "SucceedsEqual", "DoubleLeftTee", "COMPATIBILITYKanjiSpace", 
"LeftDoubleBracket", "RightDoubleBracket", "LeftAssociation", "RightAssociation", "Shah", "WolframLanguageLogo", 
"WolframLanguageLogoCircle", "TwoWayRule", "FreeformPrompt", "WolframAlphaPrompt", "InvisibleSpace", "Piecewise", 
"NegativeVeryThinSpace", "NegativeThinSpace", "NegativeMediumSpace", "NegativeThickSpace", "ImplicitPlus", "Null", 
"COMPATIBILITYNoBreak", "IndentingNewLine", "AutoPlaceholder", "AutoLeftMatch", "AutoRightMatch", "AutoSpace", 
"AutoOperand", "SystemsModelDelay", "Continuation", "RoundSpaceIndicator", "InvisiblePrefixScriptBase", 
"InvisiblePostfixScriptBase", "EntityStart", "EntityEnd", "SpanFromLeft", "SpanFromAbove", "SpanFromBoth", 
"PageBreakAbove", "PageBreakBelow", "DiscretionaryPageBreakAbove", "DiscretionaryPageBreakBelow", "Transpose", 
"Conjugate", "ConjugateTranspose", "StepperRight", "StepperLeft", "StepperUp", "StepperDown", "HermitianConjugate", 
"VerticalBar", "NotVerticalBar", "Distributed", "Conditioned", "UndirectedEdge", "DirectedEdge", "Gradient", 
"Divergence", "Curl", "ContinuedFractionK", "TensorProduct", "TensorWedge", "ProbabilityPr", "ExpectationE", 
...
CODEPOINT_LONGNAME_PARTIALD, CODEPOINT_LONGNAME_EXISTS, CODEPOINT_LONGNAME_NOTEXISTS, CODEPOINT_LONGNAME_LAPLACIAN, 
CODEPOINT_LONGNAME_DEL, CODEPOINT_LONGNAME_ELEMENT, CODEPOINT_LONGNAME_NOTELEMENT, CODEPOINT_LONGNAME_REVERSEELEMENT, 
...
CODEPOINT_LONGNAME_DIRECTEDEDGE, CODEPOINT_LONGNAME_GRADIENT, CODEPOINT_LONGNAME_DIVERGENCE, CODEPOINT_LONGNAME_CURL, 
CODEPOINT_LONGNAME_CONTINUEDFRACTIONK, CODEPOINT_LONGNAME_TENSORPRODUCT, CODEPOINT_LONGNAME_TENSORWEDGE, 
CODEPOINT_LONGNAME_PROBABILITYPR, CODEPOINT_LONGNAME_EXPECTATIONE, CODEPOINT_LONGNAME_PERMUTATIONPRODUCT, 
CODEPOINT_LONGNAME_NOTEQUALTILDE, CODEPOINT_LONGNAME_NOTHUMPEQUAL, CODEPOINT_LONGNAME_NOTHUMPDOWNHUMP, 
CODEPOINT_LONGNAME_NOTLEFTTRIANGLEBAR, CODEPOINT_LONGNAME_NOTRIGHTTRIANGLEBAR, CODEPOINT_LONGNAME_NOTLESSLESS, 
CODEPOINT_LONGNAME_NOTNESTEDLESSLESS, CODEPOINT_LONGNAME_NOTLESSSLANTEQUAL, CODEPOINT_LONGNAME_NOTGREATERGREATER, 
CODEPOINT_LONGNAME_NOTNESTEDGREATERGREATER, CODEPOINT_LONGNAME_NOTGREATERSLANTEQUAL, CODEPOINT_LONGNAME_NOTPRECEDESEQUAL
, CODEPOINT_LONGNAME_NOTSUCCEEDSEQUAL, CODEPOINT_LONGNAME_NOTSQUARESUBSET, CODEPOINT_LONGNAME_NOTSQUARESUPERSET, 
CODEPOINT_LONGNAME_EQUAL, CODEPOINT_LONGNAME_VERTICALSEPARATOR, CODEPOINT_LONGNAME_VECTORGREATER, 
CODEPOINT_LONGNAME_VECTORGREATEREQUAL, CODEPOINT_LONGNAME_VECTORLESS, CODEPOINT_LONGNAME_VECTORLESSEQUAL, 
CODEPOINT_LONGNAME_LIMIT, CODEPOINT_LONGNAME_MAXLIMIT, CODEPOINT_LONGNAME_MINLIMIT, CODEPOINT_LONGNAME_CROSS, 
CODEPOINT_LONGNAME_FUNCTION, CODEPOINT_LONGNAME_XNOR, CODEPOINT_LONGNAME_DISCRETESHIFT, 
CODEPOINT_LONGNAME_DIFFERENCEDELTA, CODEPOINT_LONGNAME_DISCRETERATIO, CODEPOINT_LONGNAME_RULEDELAYED, 
CODEPOINT_LONGNAME_SQUARE, CODEPOINT_LONGNAME_RULE, CODEPOINT_LONGNAME_IMPLIES, CODEPOINT_LONGNAME_SHORTRIGHTARROW, 
CODEPOINT_LONGNAME_SHORTLEFTARROW, CODEPOINT_LONGNAME_SHORTUPARROW, CODEPOINT_LONGNAME_SHORTDOWNARROW, 
CODEPOINT_LONGNAME_APPLICATION, CODEPOINT_LONGNAME_LEFTBRACKETINGBAR, CODEPOINT_LONGNAME_RIGHTBRACKETINGBAR, 
CODEPOINT_LONGNAME_LEFTDOUBLEBRACKETINGBAR, CODEPOINT_LONGNAME_RIGHTDOUBLEBRACKETINGBAR, 
CODEPOINT_LONGNAME_CAPITALDIFFERENTIALD, CODEPOINT_LONGNAME_DIFFERENTIALD, CODEPOINT_LONGNAME_INVISIBLECOMMA, 
CODEPOINT_LONGNAME_INVISIBLEAPPLICATION, CODEPOINT_LONGNAME_LONGEQUAL, 
];
...
match c {
CODEPOINT_LONGNAME_NOT => return TOKEN_LONGNAME_NOT,
CODEPOINT_LONGNAME_PLUSMINUS => return TOKEN_LONGNAME_PLUSMINUS,
CODEPOINT_LONGNAME_CENTERDOT => return TOKEN_LONGNAME_CENTERDOT,
CODEPOINT_LONGNAME_TIMES => return TOKEN_LONGNAME_TIMES,
CODEPOINT_LONGNAME_DIVIDE => return TOKEN_LONGNAME_DIVIDE,
CODEPOINT_LONGNAME_OPENCURLYQUOTE => return TOKEN_LONGNAME_OPENCURLYQUOTE,
CODEPOINT_LONGNAME_CLOSECURLYQUOTE => return TOKEN_LONGNAME_CLOSECURLYQUOTE,
CODEPOINT_LONGNAME_OPENCURLYDOUBLEQUOTE => return TOKEN_LONGNAME_OPENCURLYDOUBLEQUOTE,
CODEPOINT_LONGNAME_CLOSECURLYDOUBLEQUOTE => return TOKEN_LONGNAME_CLOSECURLYDOUBLEQUOTE,
CODEPOINT_LONGNAME_INVISIBLETIMES => return TOKEN_LONGNAME_INVISIBLETIMES,
CODEPOINT_LONGNAME_LEFTARROW => return TOKEN_LONGNAME_LEFTARROW,
CODEPOINT_LONGNAME_UPARROW => return TOKEN_LONGNAME_UPARROW,
CODEPOINT_LONGNAME_RIGHTARROW => return TOKEN_LONGNAME_RIGHTARROW,
CODEPOINT_LONGNAME_DOWNARROW => return TOKEN_LONGNAME_DOWNARROW,
CODEPOINT_LONGNAME_LEFTRIGHTARROW => return TOKEN_LONGNAME_LEFTRIGHTARROW,
CODEPOINT_LONGNAME_UPDOWNARROW => return TOKEN_LONGNAME_UPDOWNARROW,
CODEPOINT_LONGNAME_UPPERLEFTARROW => return TOKEN_LONGNAME_UPPERLEFTARROW,
CODEPOINT_LONGNAME_UPPERRIGHTARROW => return TOKEN_LONGNAME_UPPERRIGHTARROW,
CODEPOINT_LONGNAME_LOWERRIGHTARROW => return TOKEN_LONGNAME_LOWERRIGHTARROW,
CODEPOINT_LONGNAME_LOWERLEFTARROW => return TOKEN_LONGNAME_LOWERLEFTARROW,
CODEPOINT_LONGNAME_LEFTTEEARROW => return TOKEN_LONGNAME_LEFTTEEARROW,
CODEPOINT_LONGNAME_UPTEEARROW => return TOKEN_LONGNAME_UPTEEARROW,
CODEPOINT_LONGNAME_RIGHTTEEARROW => return TOKEN_LONGNAME_RIGHTTEEARROW,
CODEPOINT_LONGNAME_DOWNTEEARROW => return TOKEN_LONGNAME_DOWNTEEARROW,
CODEPOINT_LONGNAME_LEFTVECTOR => return TOKEN_LONGNAME_LEFTVECTOR,
CODEPOINT_LONGNAME_DOWNLEFTVECTOR => return TOKEN_LONGNAME_DOWNLEFTVECTOR,
CODEPOINT_LONGNAME_RIGHTUPVECTOR => return TOKEN_LONGNAME_RIGHTUPVECTOR,
CODEPOINT_LONGNAME_LEFTUPVECTOR => return TOKEN_LONGNAME_LEFTUPVECTOR,
CODEPOINT_LONGNAME_RIGHTVECTOR => return TOKEN_LONGNAME_RIGHTVECTOR,
CODEPOINT_LONGNAME_DOWNRIGHTVECTOR => return TOKEN_LONGNAME_DOWNRIGHTVECTOR,
CODEPOINT_LONGNAME_RIGHTDOWNVECTOR => return TOKEN_LONGNAME_RIGHTDOWNVECTOR,
CODEPOINT_LONGNAME_LEFTDOWNVECTOR => return TOKEN_LONGNAME_LEFTDOWNVECTOR,
CODEPOINT_LONGNAME_RIGHTARROWLEFTARROW => return TOKEN_LONGNAME_RIGHTARROWLEFTARROW,
CODEPOINT_LONGNAME_UPARROWDOWNARROW => return TOKEN_LONGNAME_UPARROWDOWNARROW,
CODEPOINT_LONGNAME_LEFTARROWRIGHTARROW => return TOKEN_LONGNAME_LEFTARROWRIGHTARROW,
CODEPOINT_LONGNAME_REVERSEEQUILIBRIUM => return TOKEN_LONGNAME_REVERSEEQUILIBRIUM,
CODEPOINT_LONGNAME_EQUILIBRIUM => return TOKEN_LONGNAME_EQUILIBRIUM,
CODEPOINT_LONGNAME_DOUBLELEFTARROW => return TOKEN_LONGNAME_DOUBLELEFTARROW,
CODEPOINT_LONGNAME_DOUBLEUPARROW => return TOKEN_LONGNAME_DOUBLEUPARROW,
CODEPOINT_LONGNAME_DOUBLERIGHTARROW => return TOKEN_LONGNAME_DOUBLERIGHTARROW,
CODEPOINT_LONGNAME_DOUBLEDOWNARROW => return TOKEN_LONGNAME_DOUBLEDOWNARROW,
CODEPOINT_LONGNAME_DOUBLELEFTRIGHTARROW => return TOKEN_LONGNAME_DOUBLELEFTRIGHTARROW,
CODEPOINT_LONGNAME_DOUBLEUPDOWNARROW => return TOKEN_LONGNAME_DOUBLEUPDOWNARROW,
CODEPOINT_LONGNAME_LEFTARROWBAR => return TOKEN_LONGNAME_LEFTARROWBAR,
CODEPOINT_LONGNAME_RIGHTARROWBAR => return TOKEN_LONGNAME_RIGHTARROWBAR,
CODEPOINT_LONGNAME_DOWNARROWUPARROW => return TOKEN_LONGNAME_DOWNARROWUPARROW,
CODEPOINT_LONGNAME_FORALL => return TOKEN_LONGNAME_FORALL,
CODEPOINT_LONGNAME_PARTIALD => return TOKEN_LONGNAME_PARTIALD,
CODEPOINT_LONGNAME_EXISTS => return TOKEN_LONGNAME_EXISTS,
CODEPOINT_LONGNAME_NOTEXISTS => return TOKEN_LONGNAME_NOTEXISTS,
CODEPOINT_LONGNAME_LAPLACIAN => return TOKEN_LONGNAME_LAPLACIAN,
CODEPOINT_LONGNAME_DEL => return TOKEN_LONGNAME_DEL,
CODEPOINT_LONGNAME_ELEMENT => return TOKEN_LONGNAME_ELEMENT,
CODEPOINT_LONGNAME_NOTELEMENT => return TOKEN_LONGNAME_NOTELEMENT,
CODEPOINT_LONGNAME_REVERSEELEMENT => return TOKEN_LONGNAME_REVERSEELEMENT,
CODEPOINT_LONGNAME_NOTREVERSEELEMENT => return TOKEN_LONGNAME_NOTREVERSEELEMENT,
CODEPOINT_LONGNAME_SUCHTHAT => return TOKEN_LONGNAME_SUCHTHAT,
CODEPOINT_LONGNAME_PRODUCT => return TOKEN_LONGNAME_PRODUCT,
CODEPOINT_LONGNAME_COPRODUCT => return TOKEN_LONGNAME_COPRODUCT,
CODEPOINT_LONGNAME_SUM => return TOKEN_LONGNAME_SUM,
CODEPOINT_LONGNAME_MINUS => return TOKEN_LONGNAME_MINUS,
CODEPOINT_LONGNAME_MINUSPLUS => return TOKEN_LONGNAME_MINUSPLUS,
CODEPOINT_LONGNAME_DIVISIONSLASH => return TOKEN_LONGNAME_DIVISIONSLASH,
CODEPOINT_LONGNAME_BACKSLASH => return TOKEN_LONGNAME_BACKSLASH,
CODEPOINT_LONGNAME_SMALLCIRCLE => return TOKEN_LONGNAME_SMALLCIRCLE,
CODEPOINT_LONGNAME_SQRT => return TOKEN_LONGNAME_SQRT,
CODEPOINT_LONGNAME_CUBEROOT => return TOKEN_LONGNAME_CUBEROOT,
CODEPOINT_LONGNAME_PROPORTIONAL => return TOKEN_LONGNAME_PROPORTIONAL,
CODEPOINT_LONGNAME_DIVIDES => return TOKEN_LONGNAME_DIVIDES,
CODEPOINT_LONGNAME_DOUBLEVERTICALBAR => return TOKEN_LONGNAME_DOUBLEVERTICALBAR,
CODEPOINT_LONGNAME_NOTDOUBLEVERTICALBAR => return TOKEN_LONGNAME_NOTDOUBLEVERTICALBAR,
CODEPOINT_LONGNAME_AND => return TOKEN_LONGNAME_AND,
CODEPOINT_LONGNAME_OR => return TOKEN_LONGNAME_OR,
CODEPOINT_LONGNAME_INTEGRAL => return TOKEN_LONGNAME_INTEGRAL,
CODEPOINT_LONGNAME_CONTOURINTEGRAL => return TOKEN_LONGNAME_CONTOURINTEGRAL,
CODEPOINT_LONGNAME_DOUBLECONTOURINTEGRAL => return TOKEN_LONGNAME_DOUBLECONTOURINTEGRAL,
CODEPOINT_LONGNAME_CLOCKWISECONTOURINTEGRAL => return TOKEN_LONGNAME_CLOCKWISECONTOURINTEGRAL,
CODEPOINT_LONGNAME_COUNTERCLOCKWISECONTOURINTEGRAL => return TOKEN_LONGNAME_COUNTERCLOCKWISECONTOURINTEGRAL,
CODEPOINT_LONGNAME_THEREFORE => return TOKEN_LONGNAME_THEREFORE,
CODEPOINT_LONGNAME_BECAUSE => return TOKEN_LONGNAME_BECAUSE,
CODEPOINT_LONGNAME_COLON => return TOKEN_LONGNAME_COLON,
CODEPOINT_LONGNAME_PROPORTION => return TOKEN_LONGNAME_PROPORTION,
CODEPOINT_LONGNAME_TILDE => return TOKEN_LONGNAME_TILDE,
CODEPOINT_LONGNAME_VERTICALTILDE => return TOKEN_LONGNAME_VERTICALTILDE,
CODEPOINT_LONGNAME_NOTTILDE => return TOKEN_LONGNAME_NOTTILDE,
CODEPOINT_LONGNAME_EQUALTILDE => return TOKEN_LONGNAME_EQUALTILDE,
CODEPOINT_LONGNAME_TILDEEQUAL => return TOKEN_LONGNAME_TILDEEQUAL,
CODEPOINT_LONGNAME_NOTTILDEEQUAL => return TOKEN_LONGNAME_NOTTILDEEQUAL,
CODEPOINT_LONGNAME_TILDEFULLEQUAL => return TOKEN_LONGNAME_TILDEFULLEQUAL,
CODEPOINT_LONGNAME_NOTTILDEFULLEQUAL => return TOKEN_LONGNAME_NOTTILDEFULLEQUAL,
CODEPOINT_LONGNAME_TILDETILDE => return TOKEN_LONGNAME_TILDETILDE,
CODEPOINT_LONGNAME_NOTTILDETILDE => return TOKEN_LONGNAME_NOTTILDETILDE,
CODEPOINT_LONGNAME_CUPCAP => return TOKEN_LONGNAME_CUPCAP,
CODEPOINT_LONGNAME_HUMPDOWNHUMP => return TOKEN_LONGNAME_HUMPDOWNHUMP,
CODEPOINT_LONGNAME_HUMPEQUAL => return TOKEN_LONGNAME_HUMPEQUAL,
CODEPOINT_LONGNAME_DOTEQUAL => return TOKEN_LONGNAME_DOTEQUAL,
CODEPOINT_LONGNAME_NOTEQUAL => return TOKEN_LONGNAME_NOTEQUAL,
CODEPOINT_LONGNAME_CONGRUENT => return TOKEN_LONGNAME_CONGRUENT,
CODEPOINT_LONGNAME_NOTCONGRUENT => return TOKEN_LONGNAME_NOTCONGRUENT,
CODEPOINT_LONGNAME_LESSEQUAL => return TOKEN_LONGNAME_LESSEQUAL,
CODEPOINT_LONGNAME_GREATEREQUAL => return TOKEN_LONGNAME_GREATEREQUAL,
CODEPOINT_LONGNAME_LESSFULLEQUAL => return TOKEN_LONGNAME_LESSFULLEQUAL,
CODEPOINT_LONGNAME_GREATERFULLEQUAL => return TOKEN_LONGNAME_GREATERFULLEQUAL,
CODEPOINT_LONGNAME_NOTLESSFULLEQUAL => return TOKEN_LONGNAME_NOTLESSFULLEQUAL,
CODEPOINT_LONGNAME_NOTGREATERFULLEQUAL => return TOKEN_LONGNAME_NOTGREATERFULLEQUAL,
CODEPOINT_LONGNAME_LESSLESS => return TOKEN_LONGNAME_LESSLESS,
CODEPOINT_LONGNAME_GREATERGREATER => return TOKEN_LONGNAME_GREATERGREATER,
CODEPOINT_LONGNAME_NOTCUPCAP => return TOKEN_LONGNAME_NOTCUPCAP,
CODEPOINT_LONGNAME_NOTLESS => return TOKEN_LONGNAME_NOTLESS,
CODEPOINT_LONGNAME_NOTGREATER => return TOKEN_LONGNAME_NOTGREATER,
CODEPOINT_LONGNAME_NOTLESSEQUAL => return TOKEN_LONGNAME_NOTLESSEQUAL,
CODEPOINT_LONGNAME_NOTGREATEREQUAL => return TOKEN_LONGNAME_NOTGREATEREQUAL,
CODEPOINT_LONGNAME_LESSTILDE => return TOKEN_LONGNAME_LESSTILDE,
CODEPOINT_LONGNAME_GREATERTILDE => return TOKEN_LONGNAME_GREATERTILDE,
CODEPOINT_LONGNAME_NOTLESSTILDE => return TOKEN_LONGNAME_NOTLESSTILDE,
CODEPOINT_LONGNAME_NOTGREATERTILDE => return TOKEN_LONGNAME_NOTGREATERTILDE,
CODEPOINT_LONGNAME_LESSGREATER => return TOKEN_LONGNAME_LESSGREATER,
CODEPOINT_LONGNAME_GREATERLESS => return TOKEN_LONGNAME_GREATERLESS,
CODEPOINT_LONGNAME_NOTLESSGREATER => return TOKEN_LONGNAME_NOTLESSGREATER,
CODEPOINT_LONGNAME_NOTGREATERLESS => return TOKEN_LONGNAME_NOTGREATERLESS,
CODEPOINT_LONGNAME_PRECEDES => return TOKEN_LONGNAME_PRECEDES,
CODEPOINT_LONGNAME_SUCCEEDS => return TOKEN_LONGNAME_SUCCEEDS,
CODEPOINT_LONGNAME_PRECEDESSLANTEQUAL => return TOKEN_LONGNAME_PRECEDESSLANTEQUAL,
CODEPOINT_LONGNAME_SUCCEEDSSLANTEQUAL => return TOKEN_LONGNAME_SUCCEEDSSLANTEQUAL,
CODEPOINT_LONGNAME_PRECEDESTILDE => return TOKEN_LONGNAME_PRECEDESTILDE,
CODEPOINT_LONGNAME_SUCCEEDSTILDE => return TOKEN_LONGNAME_SUCCEEDSTILDE,
CODEPOINT_LONGNAME_NOTPRECEDES => return TOKEN_LONGNAME_NOTPRECEDES,
CODEPOINT_LONGNAME_NOTSUCCEEDS => return TOKEN_LONGNAME_NOTSUCCEEDS,
CODEPOINT_LONGNAME_SUBSET => return TOKEN_LONGNAME_SUBSET,
CODEPOINT_LONGNAME_SUPERSET => return TOKEN_LONGNAME_SUPERSET,
CODEPOINT_LONGNAME_NOTSUBSET => return TOKEN_LONGNAME_NOTSUBSET,
CODEPOINT_LONGNAME_NOTSUPERSET => return TOKEN_LONGNAME_NOTSUPERSET,
CODEPOINT_LONGNAME_SUBSETEQUAL => return TOKEN_LONGNAME_SUBSETEQUAL,
CODEPOINT_LONGNAME_SUPERSETEQUAL => return TOKEN_LONGNAME_SUPERSETEQUAL,
CODEPOINT_LONGNAME_NOTSUBSETEQUAL => return TOKEN_LONGNAME_NOTSUBSETEQUAL,
CODEPOINT_LONGNAME_NOTSUPERSETEQUAL => return TOKEN_LONGNAME_NOTSUPERSETEQUAL,
CODEPOINT_LONGNAME_UNIONPLUS => return TOKEN_LONGNAME_UNIONPLUS,
CODEPOINT_LONGNAME_SQUARESUBSET => return TOKEN_LONGNAME_SQUARESUBSET,
CODEPOINT_LONGNAME_SQUARESUPERSET => return TOKEN_LONGNAME_SQUARESUPERSET,
CODEPOINT_LONGNAME_SQUARESUBSETEQUAL => return TOKEN_LONGNAME_SQUARESUBSETEQUAL,
CODEPOINT_LONGNAME_SQUARESUPERSETEQUAL => return TOKEN_LONGNAME_SQUARESUPERSETEQUAL,
CODEPOINT_LONGNAME_SQUAREINTERSECTION => return TOKEN_LONGNAME_SQUAREINTERSECTION,
CODEPOINT_LONGNAME_SQUAREUNION => return TOKEN_LONGNAME_SQUAREUNION,
CODEPOINT_LONGNAME_CIRCLEPLUS => return TOKEN_LONGNAME_CIRCLEPLUS,
CODEPOINT_LONGNAME_CIRCLEMINUS => return TOKEN_LONGNAME_CIRCLEMINUS,
CODEPOINT_LONGNAME_CIRCLETIMES => return TOKEN_LONGNAME_CIRCLETIMES,
CODEPOINT_LONGNAME_CIRCLEDOT => return TOKEN_LONGNAME_CIRCLEDOT,
CODEPOINT_LONGNAME_RIGHTTEE => return TOKEN_LONGNAME_RIGHTTEE,
CODEPOINT_LONGNAME_LEFTTEE => return TOKEN_LONGNAME_LEFTTEE,
CODEPOINT_LONGNAME_DOWNTEE => return TOKEN_LONGNAME_DOWNTEE,
CODEPOINT_LONGNAME_UPTEE => return TOKEN_LONGNAME_UPTEE,
CODEPOINT_LONGNAME_DOUBLERIGHTTEE => return TOKEN_LONGNAME_DOUBLERIGHTTEE,
CODEPOINT_LONGNAME_LEFTTRIANGLE => return TOKEN_LONGNAME_LEFTTRIANGLE,
CODEPOINT_LONGNAME_RIGHTTRIANGLE => return TOKEN_LONGNAME_RIGHTTRIANGLE,
CODEPOINT_LONGNAME_LEFTTRIANGLEEQUAL => return TOKEN_LONGNAME_LEFTTRIANGLEEQUAL,
CODEPOINT_LONGNAME_RIGHTTRIANGLEEQUAL => return TOKEN_LONGNAME_RIGHTTRIANGLEEQUAL,
CODEPOINT_LONGNAME_XOR => return TOKEN_LONGNAME_XOR,
CODEPOINT_LONGNAME_NAND => return TOKEN_LONGNAME_NAND,
CODEPOINT_LONGNAME_NOR => return TOKEN_LONGNAME_NOR,
CODEPOINT_LONGNAME_WEDGE => return TOKEN_LONGNAME_WEDGE,
CODEPOINT_LONGNAME_VEE => return TOKEN_LONGNAME_VEE,
CODEPOINT_LONGNAME_INTERSECTION => return TOKEN_LONGNAME_INTERSECTION,
CODEPOINT_LONGNAME_UNION => return TOKEN_LONGNAME_UNION,
CODEPOINT_LONGNAME_DIAMOND => return TOKEN_LONGNAME_DIAMOND,
CODEPOINT_LONGNAME_STAR => return TOKEN_LONGNAME_STAR,
CODEPOINT_LONGNAME_LESSEQUALGREATER => return TOKEN_LONGNAME_LESSEQUALGREATER,
CODEPOINT_LONGNAME_GREATEREQUALLESS => return TOKEN_LONGNAME_GREATEREQUALLESS,
CODEPOINT_LONGNAME_NOTPRECEDESSLANTEQUAL => return TOKEN_LONGNAME_NOTPRECEDESSLANTEQUAL,
CODEPOINT_LONGNAME_NOTSUCCEEDSSLANTEQUAL => return TOKEN_LONGNAME_NOTSUCCEEDSSLANTEQUAL,
CODEPOINT_LONGNAME_NOTSQUARESUBSETEQUAL => return TOKEN_LONGNAME_NOTSQUARESUBSETEQUAL,
CODEPOINT_LONGNAME_NOTSQUARESUPERSETEQUAL => return TOKEN_LONGNAME_NOTSQUARESUPERSETEQUAL,
CODEPOINT_LONGNAME_NOTPRECEDESTILDE => return TOKEN_LONGNAME_NOTPRECEDESTILDE,
CODEPOINT_LONGNAME_NOTSUCCEEDSTILDE => return TOKEN_LONGNAME_NOTSUCCEEDSTILDE,
CODEPOINT_LONGNAME_NOTLEFTTRIANGLE => return TOKEN_LONGNAME_NOTLEFTTRIANGLE,
CODEPOINT_LONGNAME_NOTRIGHTTRIANGLE => return TOKEN_LONGNAME_NOTRIGHTTRIANGLE,
CODEPOINT_LONGNAME_NOTLEFTTRIANGLEEQUAL => return TOKEN_LONGNAME_NOTLEFTTRIANGLEEQUAL,
CODEPOINT_LONGNAME_NOTRIGHTTRIANGLEEQUAL => return TOKEN_LONGNAME_NOTRIGHTTRIANGLEEQUAL,
CODEPOINT_LONGNAME_LEFTCEILING => return TOKEN_LONGNAME_LEFTCEILING,
CODEPOINT_LONGNAME_RIGHTCEILING => return TOKEN_LONGNAME_RIGHTCEILING,
CODEPOINT_LONGNAME_LEFTFLOOR => return TOKEN_LONGNAME_LEFTFLOOR,
CODEPOINT_LONGNAME_RIGHTFLOOR => return TOKEN_LONGNAME_RIGHTFLOOR,
CODEPOINT_LONGNAME_CAP => return TOKEN_LONGNAME_CAP,
CODEPOINT_LONGNAME_CUP => return TOKEN_LONGNAME_CUP,
CODEPOINT_LONGNAME_LEFTANGLEBRACKET => return TOKEN_LONGNAME_LEFTANGLEBRACKET,
CODEPOINT_LONGNAME_RIGHTANGLEBRACKET => return TOKEN_LONGNAME_RIGHTANGLEBRACKET,
CODEPOINT_LONGNAME_PERPENDICULAR => return TOKEN_LONGNAME_PERPENDICULAR,
CODEPOINT_LONGNAME_LONGLEFTARROW => return TOKEN_LONGNAME_LONGLEFTARROW,
CODEPOINT_LONGNAME_LONGRIGHTARROW => return TOKEN_LONGNAME_LONGRIGHTARROW,
CODEPOINT_LONGNAME_LONGLEFTRIGHTARROW => return TOKEN_LONGNAME_LONGLEFTRIGHTARROW,
CODEPOINT_LONGNAME_DOUBLELONGLEFTARROW => return TOKEN_LONGNAME_DOUBLELONGLEFTARROW,
CODEPOINT_LONGNAME_DOUBLELONGRIGHTARROW => return TOKEN_LONGNAME_DOUBLELONGRIGHTARROW,
CODEPOINT_LONGNAME_DOUBLELONGLEFTRIGHTARROW => return TOKEN_LONGNAME_DOUBLELONGLEFTRIGHTARROW,
CODEPOINT_LONGNAME_UPARROWBAR => return TOKEN_LONGNAME_UPARROWBAR,
CODEPOINT_LONGNAME_DOWNARROWBAR => return TOKEN_LONGNAME_DOWNARROWBAR,
CODEPOINT_LONGNAME_LEFTRIGHTVECTOR => return TOKEN_LONGNAME_LEFTRIGHTVECTOR,
CODEPOINT_LONGNAME_RIGHTUPDOWNVECTOR => return TOKEN_LONGNAME_RIGHTUPDOWNVECTOR,
CODEPOINT_LONGNAME_DOWNLEFTRIGHTVECTOR => return TOKEN_LONGNAME_DOWNLEFTRIGHTVECTOR,
CODEPOINT_LONGNAME_LEFTUPDOWNVECTOR => return TOKEN_LONGNAME_LEFTUPDOWNVECTOR,
CODEPOINT_LONGNAME_LEFTVECTORBAR => return TOKEN_LONGNAME_LEFTVECTORBAR,
CODEPOINT_LONGNAME_RIGHTVECTORBAR => return TOKEN_LONGNAME_RIGHTVECTORBAR,
CODEPOINT_LONGNAME_RIGHTUPVECTORBAR => return TOKEN_LONGNAME_RIGHTUPVECTORBAR,
CODEPOINT_LONGNAME_RIGHTDOWNVECTORBAR => return TOKEN_LONGNAME_RIGHTDOWNVECTORBAR,
CODEPOINT_LONGNAME_DOWNLEFTVECTORBAR => return TOKEN_LONGNAME_DOWNLEFTVECTORBAR,
CODEPOINT_LONGNAME_DOWNRIGHTVECTORBAR => return TOKEN_LONGNAME_DOWNRIGHTVECTORBAR,
CODEPOINT_LONGNAME_LEFTUPVECTORBAR => return TOKEN_LONGNAME_LEFTUPVECTORBAR,
CODEPOINT_LONGNAME_LEFTDOWNVECTORBAR => return TOKEN_LONGNAME_LEFTDOWNVECTORBAR,
CODEPOINT_LONGNAME_LEFTTEEVECTOR => return TOKEN_LONGNAME_LEFTTEEVECTOR,
CODEPOINT_LONGNAME_RIGHTTEEVECTOR => return TOKEN_LONGNAME_RIGHTTEEVECTOR,
CODEPOINT_LONGNAME_RIGHTUPTEEVECTOR => return TOKEN_LONGNAME_RIGHTUPTEEVECTOR,
CODEPOINT_LONGNAME_RIGHTDOWNTEEVECTOR => return TOKEN_LONGNAME_RIGHTDOWNTEEVECTOR,
CODEPOINT_LONGNAME_DOWNLEFTTEEVECTOR => return TOKEN_LONGNAME_DOWNLEFTTEEVECTOR,
CODEPOINT_LONGNAME_DOWNRIGHTTEEVECTOR => return TOKEN_LONGNAME_DOWNRIGHTTEEVECTOR,
CODEPOINT_LONGNAME_LEFTUPTEEVECTOR => return TOKEN_LONGNAME_LEFTUPTEEVECTOR,
CODEPOINT_LONGNAME_LEFTDOWNTEEVECTOR => return TOKEN_LONGNAME_LEFTDOWNTEEVECTOR,
CODEPOINT_LONGNAME_UPEQUILIBRIUM => return TOKEN_LONGNAME_UPEQUILIBRIUM,
CODEPOINT_LONGNAME_REVERSEUPEQUILIBRIUM => return TOKEN_LONGNAME_REVERSEUPEQUILIBRIUM,
CODEPOINT_LONGNAME_ROUNDIMPLIES => return TOKEN_LONGNAME_ROUNDIMPLIES,
CODEPOINT_LONGNAME_LEFTTRIANGLEBAR => return TOKEN_LONGNAME_LEFTTRIANGLEBAR,
CODEPOINT_LONGNAME_RIGHTTRIANGLEBAR => return TOKEN_LONGNAME_RIGHTTRIANGLEBAR,
CODEPOINT_LONGNAME_EQUIVALENT => return TOKEN_LONGNAME_EQUIVALENT,
CODEPOINT_LONGNAME_LESSSLANTEQUAL => return TOKEN_LONGNAME_LESSSLANTEQUAL,
CODEPOINT_LONGNAME_GREATERSLANTEQUAL => return TOKEN_LONGNAME_GREATERSLANTEQUAL,
CODEPOINT_LONGNAME_NESTEDLESSLESS => return TOKEN_LONGNAME_NESTEDLESSLESS,
CODEPOINT_LONGNAME_NESTEDGREATERGREATER => return TOKEN_LONGNAME_NESTEDGREATERGREATER,
CODEPOINT_LONGNAME_PRECEDESEQUAL => return TOKEN_LONGNAME_PRECEDESEQUAL,
CODEPOINT_LONGNAME_SUCCEEDSEQUAL => return TOKEN_LONGNAME_SUCCEEDSEQUAL,
CODEPOINT_LONGNAME_DOUBLELEFTTEE => return TOKEN_LONGNAME_DOUBLELEFTTEE,
CODEPOINT_LONGNAME_LEFTDOUBLEBRACKET => return TOKEN_LONGNAME_LEFTDOUBLEBRACKET,
CODEPOINT_LONGNAME_RIGHTDOUBLEBRACKET => return TOKEN_LONGNAME_RIGHTDOUBLEBRACKET,
CODEPOINT_LONGNAME_LEFTASSOCIATION => return TOKEN_LONGNAME_LEFTASSOCIATION,
CODEPOINT_LONGNAME_RIGHTASSOCIATION => return TOKEN_LONGNAME_RIGHTASSOCIATION,
CODEPOINT_LONGNAME_TWOWAYRULE => return TOKEN_LONGNAME_TWOWAYRULE,
CODEPOINT_LONGNAME_PIECEWISE => return TOKEN_LONGNAME_PIECEWISE,
CODEPOINT_LONGNAME_IMPLICITPLUS => return TOKEN_LONGNAME_IMPLICITPLUS,
CODEPOINT_LONGNAME_AUTOLEFTMATCH => return TOKEN_LONGNAME_AUTOLEFTMATCH,
CODEPOINT_LONGNAME_AUTORIGHTMATCH => return TOKEN_LONGNAME_AUTORIGHTMATCH,
CODEPOINT_LONGNAME_INVISIBLEPREFIXSCRIPTBASE => return TOKEN_LONGNAME_INVISIBLEPREFIXSCRIPTBASE,
CODEPOINT_LONGNAME_INVISIBLEPOSTFIXSCRIPTBASE => return TOKEN_LONGNAME_INVISIBLEPOSTFIXSCRIPTBASE,
CODEPOINT_LONGNAME_TRANSPOSE => return TOKEN_LONGNAME_TRANSPOSE,
CODEPOINT_LONGNAME_CONJUGATE => return TOKEN_LONGNAME_CONJUGATE,
CODEPOINT_LONGNAME_CONJUGATETRANSPOSE => return TOKEN_LONGNAME_CONJUGATETRANSPOSE,
CODEPOINT_LONGNAME_HERMITIANCONJUGATE => return TOKEN_LONGNAME_HERMITIANCONJUGATE,
CODEPOINT_LONGNAME_VERTICALBAR => return TOKEN_LONGNAME_VERTICALBAR,
CODEPOINT_LONGNAME_NOTVERTICALBAR => return TOKEN_LONGNAME_NOTVERTICALBAR,
CODEPOINT_LONGNAME_DISTRIBUTED => return TOKEN_LONGNAME_DISTRIBUTED,
CODEPOINT_LONGNAME_CONDITIONED => return TOKEN_LONGNAME_CONDITIONED,
CODEPOINT_LONGNAME_UNDIRECTEDEDGE => return TOKEN_LONGNAME_UNDIRECTEDEDGE,
CODEPOINT_LONGNAME_DIRECTEDEDGE => return TOKEN_LONGNAME_DIRECTEDEDGE,
CODEPOINT_LONGNAME_GRADIENT => return TOKEN_LONGNAME_GRADIENT,
CODEPOINT_LONGNAME_DIVERGENCE => return TOKEN_LONGNAME_DIVERGENCE,
CODEPOINT_LONGNAME_CURL => return TOKEN_LONGNAME_CURL,
CODEPOINT_LONGNAME_CONTINUEDFRACTIONK => return TOKEN_LONGNAME_CONTINUEDFRACTIONK,
CODEPOINT_LONGNAME_TENSORPRODUCT => return TOKEN_LONGNAME_TENSORPRODUCT,
CODEPOINT_LONGNAME_TENSORWEDGE => return TOKEN_LONGNAME_TENSORWEDGE,
CODEPOINT_LONGNAME_PROBABILITYPR => return TOKEN_LONGNAME_PROBABILITYPR,
CODEPOINT_LONGNAME_EXPECTATIONE => return TOKEN_LONGNAME_EXPECTATIONE,
CODEPOINT_LONGNAME_PERMUTATIONPRODUCT => return TOKEN_LONGNAME_PERMUTATIONPRODUCT,
CODEPOINT_LONGNAME_NOTEQUALTILDE => return TOKEN_LONGNAME_NOTEQUALTILDE,
CODEPOINT_LONGNAME_NOTHUMPEQUAL => return TOKEN_LONGNAME_NOTHUMPEQUAL,
CODEPOINT_LONGNAME_NOTHUMPDOWNHUMP => return TOKEN_LONGNAME_NOTHUMPDOWNHUMP,
CODEPOINT_LONGNAME_NOTLEFTTRIANGLEBAR => return TOKEN_LONGNAME_NOTLEFTTRIANGLEBAR,
CODEPOINT_LONGNAME_NOTRIGHTTRIANGLEBAR => return TOKEN_LONGNAME_NOTRIGHTTRIANGLEBAR,
CODEPOINT_LONGNAME_NOTLESSLESS => return TOKEN_LONGNAME_NOTLESSLESS,
CODEPOINT_LONGNAME_NOTNESTEDLESSLESS => return TOKEN_LONGNAME_NOTNESTEDLESSLESS,
CODEPOINT_LONGNAME_NOTLESSSLANTEQUAL => return TOKEN_LONGNAME_NOTLESSSLANTEQUAL,
CODEPOINT_LONGNAME_NOTGREATERGREATER => return TOKEN_LONGNAME_NOTGREATERGREATER,
CODEPOINT_LONGNAME_NOTNESTEDGREATERGREATER => return TOKEN_LONGNAME_NOTNESTEDGREATERGREATER,
CODEPOINT_LONGNAME_NOTGREATERSLANTEQUAL => return TOKEN_LONGNAME_NOTGREATERSLANTEQUAL,
CODEPOINT_LONGNAME_NOTPRECEDESEQUAL => return TOKEN_LONGNAME_NOTPRECEDESEQUAL,
CODEPOINT_LONGNAME_NOTSUCCEEDSEQUAL => return TOKEN_LONGNAME_NOTSUCCEEDSEQUAL,
CODEPOINT_LONGNAME_NOTSQUARESUBSET => return TOKEN_LONGNAME_NOTSQUARESUBSET,
CODEPOINT_LONGNAME_NOTSQUARESUPERSET => return TOKEN_LONGNAME_NOTSQUARESUPERSET,
CODEPOINT_LONGNAME_EQUAL => return TOKEN_LONGNAME_EQUAL,
CODEPOINT_LONGNAME_VERTICALSEPARATOR => return TOKEN_LONGNAME_VERTICALSEPARATOR,
CODEPOINT_LONGNAME_VECTORGREATER => return TOKEN_LONGNAME_VECTORGREATER,
CODEPOINT_LONGNAME_VECTORGREATEREQUAL => return TOKEN_LONGNAME_VECTORGREATEREQUAL,
CODEPOINT_LONGNAME_VECTORLESS => return TOKEN_LONGNAME_VECTORLESS,
CODEPOINT_LONGNAME_VECTORLESSEQUAL => return TOKEN_LONGNAME_VECTORLESSEQUAL,
CODEPOINT_LONGNAME_LIMIT => return TOKEN_LONGNAME_LIMIT,
CODEPOINT_LONGNAME_MAXLIMIT => return TOKEN_LONGNAME_MAXLIMIT,
CODEPOINT_LONGNAME_MINLIMIT => return TOKEN_LONGNAME_MINLIMIT,
CODEPOINT_LONGNAME_CROSS => return TOKEN_LONGNAME_CROSS,
CODEPOINT_LONGNAME_FUNCTION => return TOKEN_LONGNAME_FUNCTION,
CODEPOINT_LONGNAME_XNOR => return TOKEN_LONGNAME_XNOR,
CODEPOINT_LONGNAME_DISCRETESHIFT => return TOKEN_LONGNAME_DISCRETESHIFT,
CODEPOINT_LONGNAME_DIFFERENCEDELTA => return TOKEN_LONGNAME_DIFFERENCEDELTA,
CODEPOINT_LONGNAME_DISCRETERATIO => return TOKEN_LONGNAME_DISCRETERATIO,
CODEPOINT_LONGNAME_RULEDELAYED => return TOKEN_LONGNAME_RULEDELAYED,
CODEPOINT_LONGNAME_SQUARE => return TOKEN_LONGNAME_SQUARE,
CODEPOINT_LONGNAME_RULE => return TOKEN_LONGNAME_RULE,
CODEPOINT_LONGNAME_IMPLIES => return TOKEN_LONGNAME_IMPLIES,
CODEPOINT_LONGNAME_SHORTRIGHTARROW => return TOKEN_LONGNAME_SHORTRIGHTARROW,
CODEPOINT_LONGNAME_SHORTLEFTARROW => return TOKEN_LONGNAME_SHORTLEFTARROW,
CODEPOINT_LONGNAME_SHORTUPARROW => return TOKEN_LONGNAME_SHORTUPARROW,
CODEPOINT_LONGNAME_SHORTDOWNARROW => return TOKEN_LONGNAME_SHORTDOWNARROW,
CODEPOINT_LONGNAME_APPLICATION => return TOKEN_LONGNAME_APPLICATION,
CODEPOINT_LONGNAME_LEFTBRACKETINGBAR => return TOKEN_LONGNAME_LEFTBRACKETINGBAR,
CODEPOINT_LONGNAME_RIGHTBRACKETINGBAR => return TOKEN_LONGNAME_RIGHTBRACKETINGBAR,
CODEPOINT_LONGNAME_LEFTDOUBLEBRACKETINGBAR => return TOKEN_LONGNAME_LEFTDOUBLEBRACKETINGBAR,
CODEPOINT_LONGNAME_RIGHTDOUBLEBRACKETINGBAR => return TOKEN_LONGNAME_RIGHTDOUBLEBRACKETINGBAR,
CODEPOINT_LONGNAME_CAPITALDIFFERENTIALD => return TOKEN_LONGNAME_CAPITALDIFFERENTIALD,
CODEPOINT_LONGNAME_DIFFERENTIALD => return TOKEN_LONGNAME_DIFFERENTIALD,
CODEPOINT_LONGNAME_INVISIBLECOMMA => return TOKEN_LONGNAME_INVISIBLECOMMA,
CODEPOINT_LONGNAME_INVISIBLEAPPLICATION => return TOKEN_LONGNAME_INVISIBLEAPPLICATION,
CODEPOINT_LONGNAME_LONGEQUAL => return TOKEN_LONGNAME_LONGEQUAL,
